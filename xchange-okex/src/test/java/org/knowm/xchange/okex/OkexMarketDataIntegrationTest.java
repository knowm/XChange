...
public class OkexMarketDataIntegrationTest {
  ...
  public void testInstrumentOkexConvertions() {
    assertThat(OkexAdapters.adaptOkexInstrumentIdToInstrument("BTC-USDT-SWAP"))
        .isEqualTo(new FuturesContract("BTC/USDT/SWAP"));
    assertThat(OkexAdapters.adaptInstrumentToOkexInstrumentId(new CurrencyPair("BTC/USDT/SWAP")))
        .isEqualTo("BTC-USDT-SWAP");
    assertThat(OkexAdapters.adaptOkexInstrumentIdToInstrument("BTC-USDT"))
        .isEqualTo(new CurrencyPair("BTC/USDT"));
    assertThat(OkexAdapters.adaptInstrumentToOkexInstrumentId(new CurrencyPair("BTC/USDT")))
        .isEqualTo("BTC-USDT");
  }
}
