...
public class OkexAccountServiceRaw extends OkexBaseService {
  ...
  public OkexResponse<List<OkexSubAccountDetails>> getSubAccounts(Boolean enable, String subAcct) throws IOException {
    return decorateApiCall(
            () -> this.okexAuthenticated.getSubAccountList(exchange.getExchangeSpecification().getApiKey(),
            signatureCreator,
            DateUtils.toUTCISODateString(new Date()),
            (String)exchange
                            .getExchangeSpecification()
            ...
            (String)
                    exchange
                            .getExchangeSpecification()
                            .getExchangeSpecificParametersItem("simulated"), enable == null ? null: enable.toString(),subAcct))
            .withRateLimiter(rateLimiter(subAccountList))
            .call();
  }

  public OkexResponse<List<OkexWalletBalance>> getSubAccountBalance(String subAcct) throws IOException {
    return decorateApiCall(
            () -> this.okexAuthenticated.getSubAccountBalance(exchange.getExchangeSpecification().getApiKey(),
                    signatureCreator,
                    DateUtils.toUTCISODateString(new Date()),
                    (String)exchange
                            .getExchangeSpecification()
                    ...
                    (String)
                            exchange
                                    .getExchangeSpecification()
                                    .getExchangeSpecificParametersItem("simulated"), subAcct))
            .withRateLimiter(rateLimiter(subAccountList))
            .call();
  }
  ...
  public OkexResponse<List<PiggyBalance>> getPiggyBalance(String ccy) throws IOException {
    return decorateApiCall(
            () -> this.okexAuthenticated.getPiggyBalance(exchange.getExchangeSpecification().getApiKey(),
                    signatureCreator,
                    DateUtils.toUTCISODateString(new Date()),
                    (String)exchange
                            .getExchangeSpecification()
                    ...
                    (String)
                            exchange
                                    .getExchangeSpecification()
                                    .getExchangeSpecificParametersItem("simulated"), ccy))
            .withRateLimiter(rateLimiter(subAccountList))
            .call();
  }
}
