...
public class BitbayAdapterTest {
  ...
  public void testAccountInfoAdapter() throws IOException {
    ...
    InputStream is = BitbayAdapterTest.class.getResourceAsStream("/org/knowm/xchange/bitbay/account/example-info-data.json");
  ...
  public void testOpenOrdersAdapter() throws IOException {
    // Read in the JSON from the example resources
    InputStream is = BitbayAdapterTest.class.getResourceAsStream("/org/knowm/xchange/bitbay/trade/example-orders-data.json");
