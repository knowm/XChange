...
public class CointraderBalanceResponse extends CointraderBaseResponse<Map<String, CointraderBalance>> {
  protected CointraderBalanceResponse(@JsonProperty("success") Boolean status, @JsonProperty("message") String message, @JsonProperty("data") Map<String, CointraderBalance> data) {
