...
/** @author Mikhail Wall */
public class DSXMarketDataServiceCore<T extends DSXAuthenticatedV2>
    extends DSXMarketDataServiceRawCore<T> implements MarketDataService {
   ...
   * @param exchange
   */
  public DSXMarketDataServiceCore(Exchange exchange, Class<T> clazz) {
