...
public interface DSXAuthenticatedV3 extends DSXAuthenticatedV2 {

  /**
   * This method provides information about user balance, server time, active orders count, rights
   * of the currently used keys.
   *
   * @return {"success": 1,"return": {"funds": {"BTC": {"total": 100,"available": 95},"USD":
   *     {"total": 10000,"available": 9995},"EUR": {"total": 1000,"available": 995},"LTC": {"total":
   *     1000,"available": 995}},"rights": {"info": 1,"trade": 1},"transactionCount":
   *     0,"openOrders": 0,"serverTime": 1496669169}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/info/account")
  @Override
  ...
  /**
   * This method provides information about active user orders. All parameters are obligatory (ie.
   * none may be null)
   *
   * @param pair the pair to display the orders eg. btcusd
   * @return {"success": 1,"return": {"0": {"pair": "btcusd","type": "buy","remainingVolume":
   *     10,"volume": 10,"rate": 1000.000, "timestampCreated": 1496670,"status": 0,"orderType":
   *     "limit"}}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/orders")
  @Override
  DSXActiveOrdersReturn getActiveOrders(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce,
  ...
  /**
   * This method provides information about user transactions history. All parameters are nullable
   *
   ...
   * @param order Order in which transactions are displayed. Possible values: "asc" — from first to
   *     last, "desc" — from last to first. Default value is "desc"
   ...
   * @param type Type of transaction. Possible values: "Withdraw" — withdraw "Incoming" — deposit.
   *     Default value is all types.
   * @param status Transaction status. Default value is all statuses. Possible values: 1 - Failed, 2
   *     - Completed, 3 - Processing, 4 - Rejected
   * @param currency Transactions currency. Default value is all currencies
   * @return {"success": 1,"return": {"1": {"id": 1,"timestamp": 11,"type": "Withdraw","amount":
   *     1,"currency": "btc","confirmationsCount": 6, "address": "address","status": 2,"commission":
   *     0.0001}}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/history/transactions")
  @Override
  DSXTransHistoryReturn transHistory(
      ...
      @FormParam("endId") Long endId,
      @FormParam("order") SortOrder order,
      @FormParam("since") Long since,
      @FormParam("end") Long end,
      @FormParam("type") DSXTransHistoryResult.Type type,
      @FormParam("status") DSXTransHistoryResult.Status status,
      @FormParam("currency") String currency)
      throws IOException;

  /**
   * This method provides information about user trades history. All parameters are nullable
   *
   ...
   * @param order Order in which trades are displayed. Possible values: "asc" — from first to last,
   ...
   * @return {"success": 1,"return": {"0": {"pair": "btcusd","type": "buy","amount": 1,"rate":
   *     1000.000,"orderId": 1,"timestamp": 1496671, "commission": 0.001,"commissionCurrency":
   *     "btc"}}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/history/trades")
  @Override
  DSXTradeHistoryReturn tradeHistory(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce,
      @DefaultValue("1000") @FormParam("count") Integer count,
      @FormParam("fromId") Long fromId,
      @FormParam("endId") Long endId,
      @FormParam("order") SortOrder order,
      @FormParam("since") Long since,
  ...
  /**
   * This method provides information about user orders history. All parameters are nullable
   *
  ...
  /**
   * This method provides trade operation. User can place limit, market, fill-or-kill orders. If you
   * place fill-or-kill or market order, send any random number for rate param All parameters,
   * except rate param, are obligatory (ie. none may be null)
   *
   ...
   * @return {"success": 1,"return": {"received": 0,"remains": 10,"funds": {"BTC": {"total":
   *     100,"available": 95},"USD": {"total": 10000,"available": 9995}, "EUR": {"total":
   *     1000,"available": 995},"LTC": {"total": 1000,"available": 995}},"orderId": 0}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/order/new")
  @Override
  ...
  /**
   * This method provides cancelling active order operation. All parameters are obligatory (ie. none
   * may be null)
   *
   * @param orderId Id of order to cancel
   * @return {"success": 1,"return": {"funds": {"BTC": {"total": 100,"available": 95},"USD":
   *     {"total": 10000,"available": 9995}, "EUR": {"total": 1000,"available": 995},"LTC":
   *     {"total": 1000,"available": 995}},"orderId": 1}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/order/cancel")
  @Override
   ...
   * @return {"success": 1,"return": {"funds": {"BTC": {"total": 100,"available": 95},"USD":
   *     {"total": 10000,"available": 9995},"EUR": {"total": 1000,"available": 995},"LTC": {"total":
   *     1000,"available": 995}},"orderId": 1}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/order/cancel/all")
  @Override
  DSXCancelAllOrdersReturn cancelAllOrders(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce)
      throws IOException;
  ...
  /**
   * This method provides order status and related deals to order All parameters are obligatory (ie.
   * none may be null)
   *
   * @param orderId Id of order to show status
   * @return {"success": 1,"return": {"pair": "btcusd","type": "buy","remainingVolume": 10,"volume":
   *     10,"rate": 1000.000,"timestampCreated": 1496670, "status": 0,"orderType": "limit","deals":
   *     [{"pair": "btcusd","type": "buy","amount": 1,"rate": 1000.000,"orderId": 1,"timestamp":
   *     1496672724, "commission": 0.001,"commissionCurrency": "btc"}]}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/order/status")
  @Override
  DSXOrderStatusReturn getOrderStatus(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce,
      @FormParam("orderId") Long orderId)
   ...
   *
   * @return {"success": 1,"return": {"progressiveCommissions": {"commissions": [{"tradingVolume":
   *     0.03,"takerCommission": 0.03,"makerCommission": 0.03}], "indexOfCurrentCommission": 0}}}
   * @throws IOException
   */
  @POST
  @Path("tapi/v3/fees")
  @Override
  DSXFeesReturn getFees(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce)
      throws IOException;
   ...
   * @param newAddress Do you want to get new crypto address or you want to receive previous
   *     address. 1 - generate new address. 0 - get old address. Default value is 0.
   * @return {"success": 1,"return": {"address": "crypto-address","currency": "BTC","new": 0}}
   * @throws IOException
   */
  @POST
  @Path("dwapi/v3/deposit/cryptoaddress")
  @Override
  ...
  /**
   * This method provides preparing for submitting crypto withdraw All parameters are obligatory
   * (ie. none may be null)
   *
   * @param currency Cryptocurrency name
   * @param address Crypto address
   * @param amount Amount of cryptocurrency you want to withdraw
   * @param commission Amount of cryptocurrency you want to spend as network fee. If not sent -
   *     default commission will be used
   * @return {"success": 1,"return": {"transactionId": 1}}
   * @throws IOException
   */
  @POST
  @Path("dwapi/v3/withdraw/crypto")
  @Override
  ...
  /**
   * This method provides submitting withdraw by transactionId, which we got from crypto or fiat
   * withdraw All parameters are obligatory (ie. none may be null)
   *
   * @param transactionId Id of transaction which you want to submit
   * @return {"success": 1,"return": {"id": 1,"timestamp": 1496673,"type": "Incoming","amount":
   *     10,"currency": "btc","confirmationsCount": 6, "address": "123123","status": 2,"commission":
   *     0.01}}
   * @throws IOException
   */
  @POST
  @Path("dwapi/v3/withdraw/submit")
  @Override
  DSXTransactionReturn submitWithdraw(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce,
  ...
  /**
   * This method provides cancelling processing withdraw All parameters are obligatory (ie. none may
   * be null)
   *
   ...
   */
  @POST
  @Path("dwapi/v3/withdraw/cancel")
  @Override
  DSXTransactionReturn cancelWithdraw(
      @HeaderParam("Key") String apiKey,
      @HeaderParam("Sign") ParamsDigest signer,
      @FormParam("nonce") SynchronizedValueFactory<Long> nonce,
      @FormParam("transactionId") Long transactionId);
   ...
   */
  @POST
  @Path("dwapi/v3/transaction/status")
  @Override
