...
public class DSXProgressiveCommissions {
  ...
  public DSXProgressiveCommissions(@JsonProperty("commissions") DSXCommission[] commissions,
      @JsonProperty("indexOfCurrentCommission") int indexOfCurrentCommission, @JsonProperty("currency") String currency) {
