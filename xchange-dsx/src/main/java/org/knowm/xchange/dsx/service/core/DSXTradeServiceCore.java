...
/** @author Mikhail Wall */
public class DSXTradeServiceCore<T extends DSXAuthenticatedV2> extends DSXTradeServiceCoreRaw<T>
    implements TradeService {

  public DSXTradeServiceCore(Exchange exchange, Class<T> clazz) {
  ...
  public UserTrades getTradeHistory(TradeHistoryParams params) throws IOException {
    ...
    if (params instanceof TradeHistoryParamsSorted) {
      ...
      if (order != null)
        sort =
            TradeHistoryParamsSorted.Order.desc == order
  ...
  public Map<Long, DSXTransHistoryResult> getTransHistory(DSXTransHistoryParams params)
    ...
    DSXAuthenticatedV2.SortOrder sort =
        TradeHistoryParamsSorted.Order.desc == params.getOrder()
            ? DSXAuthenticatedV2.SortOrder.DESC
            : DSXAuthenticatedV2.SortOrder.ASC;
