...
/** @author Mikhail Wall */
public class DSXBaseService<T extends DSXAuthenticatedV2> extends BaseExchangeService
    implements BaseService {

  private static final String ERR_MSG_NONCE = "Parameter: nonce is invalid";

  protected final String apiKey;
  protected final T dsx;
   ...
   * @throws IOException
   */
  protected DSXBaseService(Exchange exchange, Class<T> clazz) {
    super(exchange);
    this.dsx =
