...
public class DSXAccountServiceCore<T extends DSXAuthenticatedV2> extends DSXAccountServiceRawCore<T>
    implements AccountService {

  public DSXAccountServiceCore(Exchange exchange, Class<T> clazz) {
  ...
  public String withdrawFunds(Currency currency, BigDecimal amount, String address)
    ...
    boolean fiat =
        Currency.EUR.equals(currency)
            || Currency.USD.equals(currency)
            || Currency.RUB.equals(currency);
