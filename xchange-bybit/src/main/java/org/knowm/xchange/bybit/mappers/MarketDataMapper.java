...
public final class MarketDataMapper {
  ...
  public static CurrencyPairMetaData symbolToCurrencyPairMetaData(BybitSymbol bybitSymbol) {
    return new CurrencyPairMetaData.Builder()
        ...
        //e.g. 0.0010 -> 3
        .baseScale(Math.max(bybitSymbol.getLotSizeFilter().getQtyStep().stripTrailingZeros().scale(), 0))
