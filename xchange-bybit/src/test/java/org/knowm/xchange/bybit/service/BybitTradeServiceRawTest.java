...
public class BybitTradeServiceRawTest extends BaseWiremockTest {
  ...
  public void testGetBybitOrder() throws IOException {
    ...
    BybitResult<BybitOrderDetails> order =
        bybitAccountServiceRaw.getBybitOrder("1234567891011121314");
    ...
    assertThat(responseObjectResult.get("accountId").textValue())
        .isEqualTo(orderResult.getAccountId());
    assertThat(responseObjectResult.get("exchangeId").textValue())
        .isEqualTo(orderResult.getExchangeId());
    assertThat(responseObjectResult.get("symbol").textValue()).isEqualTo(orderResult.getSymbol());
    assertThat(responseObjectResult.get("symbolName").textValue())
        .isEqualTo(orderResult.getSymbolName());
    assertThat(responseObjectResult.get("orderLinkId").textValue())
        .isEqualTo(orderResult.getOrderLinkId());
    ...
    assertThat(responseObjectResult.get("executedQty").textValue())
        .isEqualTo(orderResult.getExecutedQty());
    assertThat(responseObjectResult.get("cummulativeQuoteQty").textValue())
        .isEqualTo(orderResult.getCummulativeQuoteQty());
    assertThat(responseObjectResult.get("avgPrice").textValue())
        .isEqualTo(orderResult.getAvgPrice());
    assertThat(responseObjectResult.get("status").textValue()).isEqualTo(orderResult.getStatus());
    assertThat(responseObjectResult.get("timeInForce").textValue())
        .isEqualTo(orderResult.getTimeInForce());
    ...
    assertThat(responseObjectResult.get("stopPrice").textValue())
        .isEqualTo(orderResult.getStopPrice());
    assertThat(responseObjectResult.get("icebergQty").textValue())
        .isEqualTo(orderResult.getIcebergQty());
    assertThat(responseObjectResult.get("time").textValue()).isEqualTo(orderResult.getTime());
    assertThat(responseObjectResult.get("updateTime").textValue())
        .isEqualTo(orderResult.getUpdateTime());
    assertThat(responseObjectResult.get("isWorking").booleanValue())
        .isEqualTo(orderResult.isWorking());
  ...
  public void testPlaceBybitOrder() throws IOException {
    ...
    BybitResult<BybitOrderRequest> order =
        bybitAccountServiceRaw.placeOrder("COINUSDT", 300, "SELL", "MARKET");
    ...
    assertThat(responseObjectResult.get("accountId").textValue())
        .isEqualTo(orderRequestResult.getAccountId());
    assertThat(responseObjectResult.get("symbol").textValue())
        .isEqualTo(orderRequestResult.getSymbol());
    assertThat(responseObjectResult.get("symbolName").textValue())
        .isEqualTo(orderRequestResult.getSymbolName());
    assertThat(responseObjectResult.get("orderLinkId").textValue())
    ...
    assertThat(responseObjectResult.get("price").textValue())
        .isEqualTo(orderRequestResult.getPrice());
    assertThat(responseObjectResult.get("origQty").textValue())
        .isEqualTo(orderRequestResult.getOrigQty());
    assertThat(responseObjectResult.get("executedQty").textValue())
        .isEqualTo(orderRequestResult.getExecutedQty());
    assertThat(responseObjectResult.get("status").textValue())
        .isEqualTo(orderRequestResult.getStatus());
    assertThat(responseObjectResult.get("timeInForce").textValue())
        .isEqualTo(orderRequestResult.getTimeInForce());
    assertThat(responseObjectResult.get("type").textValue())
        .isEqualTo(orderRequestResult.getType());
    assertThat(responseObjectResult.get("side").textValue())
        .isEqualTo(orderRequestResult.getSide());
