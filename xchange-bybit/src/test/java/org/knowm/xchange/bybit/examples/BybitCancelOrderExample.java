  ...
  public static void testCancelOrders() throws IOException {
    ...
    LimitOrder limitFutureOrder0 =
        new LimitOrder(
            ...
            ETH_USDT_PERP,
            null,
            null, price, null, null, null, OrderStatus.PENDING_NEW, userReference0);
    ...
    LimitOrder limitFutureOrder1 =
        new LimitOrder(
            ...
            ETH_USDT_PERP,
            null,
            null, price, null, null, null, OrderStatus.PENDING_NEW, userReference1);
    ...
    boolean resultSpot = exchange.getTradeService().cancelOrder(new BybitCancelOrderParams(ETH_USDT, limitSpotOrderId, ""));
    boolean resultFuture0 = exchange.getTradeService().cancelOrder(new BybitCancelOrderParams(ETH_USDT_PERP, limitFutureOrderId0, userReference0));
    boolean resultFuture1 = exchange.getTradeService().cancelOrder(new BybitCancelOrderParams(ETH_USDT_PERP, "", userReference1));
