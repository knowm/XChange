...
public class EnigmaTradeDemo {
  ...
  private static void raw(EnigmaTradeServiceRaw tradeService) throws IOException {
    ...
    log.info("Order submission: {}", orderSubmission.toString());
      ...
      EnigmaQuoteRequest enigmaQuoteRequest = new EnigmaQuoteRequest(
              2,
              Side.SELL.getValue(),
              new BigDecimal("0.002"),
              Infrastructure.DEVELOPMENT.getValue()
      ...
      EnigmaExecuteQuoteRequest enigmaExecuteQuoteRequest = new EnigmaExecuteQuoteRequest(
      ...
      EnigmaExecutedQuote enigmaExecutedQuote = tradeService.executeQuoteRequest(enigmaExecuteQuoteRequest);
