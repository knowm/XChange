...
public class BitcoiniumRealtimeOrderbookDemo {
	...
	public XChartPanel<XYChart> buildPanel() throws IOException {
		...
		// create chart
		chart = new XYChartBuilder().width(800).height(400).title("Real-time Bitcoinium Order Book - BITSTAMP_BTC_USD")
	...
	private void updateData() throws IOException {
		...
		BitcoiniumOrderbook bitcoiniumOrderbook = bitcoiniumMarketDataService.getBitcoiniumOrderbook("BTC",
				"BITSTAMP_USD", "TEN_PERCENT");
