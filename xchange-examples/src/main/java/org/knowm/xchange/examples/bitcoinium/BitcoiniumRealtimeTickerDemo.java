...
public class BitcoiniumRealtimeTickerDemo {
	...
	private void go() throws IOException {
		...
		TimerTask chartUpdaterTask = new TimerTask() {
			...
			public void run() {
				...
				try {
					BitcoiniumTicker bitcoiniumTicker = bitcoiniumMarketDataService.getBitcoiniumTicker("BTC",
							"BITSTAMP_USD");
	...
	public XChartPanel<XYChart> buildPanel() throws IOException {
		...
		BitcoiniumTickerHistory bitcoiniumTickerHistory = bitcoiniumMarketDataService.getBitcoiniumTickerHistory("BTC",
				"BITSTAMP_USD", "THREE_HOURS");
		...
		// Create Chart
		chart = new XYChartBuilder().width(800).height(600).title("Real-time Bitstamp Price vs. Time")
