...
/**
 * Demonstrate requesting OrderBook from BitcoinToYou and plotting it using XChart.
 * 
...
public class DepthChartDemo {
  ...
  public static void main(String[] args) throws IOException {
    ...
    // Use the factory to get the version 1 BitcoinToYou exchange API using default settings
    ...
    // Customize Chart
    chart.setChartTitle("BitcoinToYou Order Book");
