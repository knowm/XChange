...
public class TradeDemo {
  ...
  private static void raw(QuoineTradeServiceRaw tradeServiceRaw) throws IOException {
    ...
    QuoinePlaceOrderResponse quoinePlaceOrderResponse = tradeServiceRaw.placeLimitOrder(CurrencyPair.BTC_USD, "sell", new BigDecimal(".1"),
        new BigDecimal("250.00"));
    System.out.println("QuoinePlaceOrderResponse return value: " + quoinePlaceOrderResponse.toString());
  }
