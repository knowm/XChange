...
public class KrakenFuturesStreamingPrivateDataIntegration {
  ...
  public void setUp() {
    ...
    final String API_KEY =
        (properties.getProperty("apiKey") == null)
            ? System.getenv("krakenfutures_apikey")
            : properties.getProperty("apiKey");
    final String SECRET_KEY =
        (properties.getProperty("secret") == null)
            ? System.getenv("krakenfutures_secretkey")
  ...
  public void checkUserTrades() throws InterruptedException, IOException {
    ...
    Disposable dis2 =
        exchange
            .getStreamingTradeService()
            .getUserTrades(new FuturesContract("ETH/USD/PERP"))
            .retry()
            .subscribe(
                fill -> {
                  LOG.info(fill.toString());
            ...
            exchange
                ...
                .placeMarketOrder(
                    new MarketOrder.Builder(
                            Order.OrderType.ASK, new FuturesContract("ETH/USD/PERP"))
