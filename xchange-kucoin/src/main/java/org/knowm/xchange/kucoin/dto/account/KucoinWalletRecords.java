...
@JsonPropertyOrder({"datas", "total", "limit", "pageNos", "currPageNo", "navigatePageNos", "coinType", "type", "userOid", "status", "firstPage",
    "lastPage", "startRow"})
public class KucoinWalletRecords {
   ...
   * @param status
   */
  public KucoinWalletRecords(List<KucoinWalletRecord> records, Integer total, Integer limit, Integer pageNos, Integer currPageNo,
      List<Integer> navigatePageNos, String coinType, KucoinWalletOperation type, String userOid, String status, Boolean firstPage, Boolean lastPage,
      Integer startRow) {
    super();
