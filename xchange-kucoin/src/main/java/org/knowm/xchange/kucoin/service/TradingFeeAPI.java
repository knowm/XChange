...
public interface TradingFeeAPI {
    ...
    @GET
    @Path("/base-fee")
    KucoinResponse<Map<String, BigDecimal>> getBaseFee(@HeaderParam(APIConstants.API_HEADER_KEY) String apiKey,
                                                       ...
                                                       @HeaderParam(APIConstants.API_HEADER_PASSPHRASE) String apiPassphrase) throws IOException;
}
