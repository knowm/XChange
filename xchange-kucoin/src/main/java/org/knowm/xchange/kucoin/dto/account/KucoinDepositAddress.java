...
public class KucoinDepositAddress {
     ...
     * @param updatedAt
     */
    public KucoinDepositAddress(String oid, String address, String context, String userOid, String coinType, Long createdAt, Long deletedAt, Long updatedAt, Long lastReceivedAt) {
        super();
        this.oid = oid;
