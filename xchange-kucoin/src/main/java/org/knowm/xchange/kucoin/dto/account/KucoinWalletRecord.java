...
@JsonPropertyOrder({"fee", "oid", "type", "amount", "remark", "status", "address", "context", "userOid", "coinType", "createdAt", "deletedAt",
    "updatedAt", "outerWalletTxid"})
public class KucoinWalletRecord {
   ...
   * @param updatedAt
   */
  public KucoinWalletRecord(BigDecimal fee, String oid, KucoinWalletOperation type, BigDecimal amount, String remark,
      KucoinWalletOperationStatus status, String address, String context, String userOid, String coinType, Long createdAt, Long deletedAt,
      Long updatedAt, String outerWalletTxid) {
    super();
    this.fee = fee;
    this.oid = oid;
    this.type = type;
