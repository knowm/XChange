...
public class KucoinAccountUnmarshalTest {
  ...
  public void testFundingRecordUnmarshal() throws IOException {
    ...
    assertThat(balance.getAddress())
        .isEqualTo("xrb_1wgznwiqs5nthtr4qgrx4q1qchnj4nqi3cw8t6jgoh5cicx8qcc4fhebw63y");
    assertThat(balance.getFee()).isEqualTo(BigDecimal.valueOf(0.0));
    assertThat(balance.getOuterWalletTxid())
        .isEqualTo("9BBC27DB999B414212CB823C453F31C05488FD523625CAD5E06A24487DC7A62F");
