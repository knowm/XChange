  ...
  public void testUnmarshal() throws IOException {
    ...
    InputStream is =
        OpenOrdersJSONTest.class.getResourceAsStream(
            "/org/knowm/xchange/taurus/dto/trade/example-openorders.json");
    ...
    //    [{"amount":"0.01000000","datetime":"2015-03-25
    // 09:31:36","id":"musi0joa54mzpj0vvpo811mr53g6cj4zewieg7plccl2wlxrbm0cnm3tqkz3343i","price":"400.00","status":"0","type":"1"}]
    // Verify that the example data was unmarshalled correctly
    assertThat(orders[0].getId())
        .isEqualTo("musi0joa54mzpj0vvpo811mr53g6cj4zewieg7plccl2wlxrbm0cnm3tqkz3343i");
