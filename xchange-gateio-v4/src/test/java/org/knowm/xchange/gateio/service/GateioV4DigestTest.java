...
class GateioV4DigestTest {
  ...
  void signature() {
    ...
    when(restInvocation.getHttpHeadersFromParams()).thenReturn(Map.of("Timestamp", "1691707273890"));

    var actual = gateioV4Digest.digestParams(restInvocation);
    var expected = "de31e211a60623ba2c41e65a3c21e550400ffccfef55578173e09f2b34cf46b426c587f01b4c12474608dc856b1ba226a71004f7989603236c885c23275d5577";
