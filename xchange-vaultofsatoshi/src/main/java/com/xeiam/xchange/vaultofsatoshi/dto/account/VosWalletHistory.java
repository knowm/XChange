...
public final class VosWalletHistory {
	...
	public VosWalletHistory(@JsonProperty("transfer_id") int transfer_id,
			@JsonProperty("transfer_date") long transfer_date,
	...
	public String toString() {
		return "VosWalletHistory [transfer_id=" + transfer_id
				+ ", transfer_date=" + transfer_date + ", type=" + type
				+ ", units=" + units + ", transaction_id=" + transaction_id
				+ ", currency=" + currency + "]";
	}
