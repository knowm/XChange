...
public final class VosWallet {
	...
	private VosCurrency balance;
	  ...
	  public VosWallet(@JsonProperty("balance") VosCurrency balance, 
			  @JsonProperty("daily_withdrawal_limit") VosCurrency daily_withdrawal_limit,
	...
	public String toString() {
		return "VosWallet [balance=" + balance + ", daily_withdrawal_limit="
