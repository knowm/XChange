...
public final class VosTradeOrder {
	  ...
	  public VosTradeOrder(@JsonProperty("order_id") int order_id, 
			  @JsonProperty("order_currency") String order_currency, 
			  @JsonProperty("order_date") long order_date,
			  @JsonProperty("payment_currency") String payment_currency,
			  @JsonProperty("type") String type,
			  @JsonProperty("status") String status,
			  @JsonProperty("units") VosCurrency units,
			  @JsonProperty("units_remaining") VosCurrency units_remaining,
			  @JsonProperty("price") VosCurrency price,
			  @JsonProperty("fee") VosCurrency fee,
	...
	public String toString() {
		return "VosOrder [order_id=" + order_id + ", order_currency="
				+ order_currency + ", order_date=" + order_date
				+ ", payment_currency=" + payment_currency + ", type=" + type
				+ ", status=" + status + ", units=" + units
				+ ", units_remaining=" + units_remaining + ", price=" + price
				+ ", fee=" + fee + ", total=" + total + ", date_completed="
				+ date_completed + "]";
	}
