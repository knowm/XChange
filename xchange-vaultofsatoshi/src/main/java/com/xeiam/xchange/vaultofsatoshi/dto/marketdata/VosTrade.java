...
public final class VosTrade {
  ...
  public VosTrade(@JsonProperty("transaction_date") long transaction_date, @JsonProperty("journal_id") long journalId, @JsonProperty("transaction_id") long transactionId,
