...
public final class VosAccount {
  ...
  public VosAccount(@JsonProperty("account_id") int account_id, @JsonProperty("created") long created, @JsonProperty("last_login") long last_login,
      @JsonProperty("monthly_volume") VosMap<VosCurrency> monthly_volume, @JsonProperty("trade_fee") VosMap<VosCurrency> trade_fee, @JsonProperty("wallets") VosMap<VosWallet> wallets,
  ...
  public String toString() {
    ...
    return "VosAccount [account_id=" + account_id + ", created=" + created + ", last_login=" + last_login + ", monthly_volume=" + monthly_volume + ", trade_fee=" + trade_fee + ", wallets=" + wallets
