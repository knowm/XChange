...
public final class VosOrderDetail {
	  ...
	  public VosOrderDetail(@JsonProperty("order_currency") String order_currency, 
			  @JsonProperty("transaction_date") long transaction_date,
	...
	public String toString() {
		return "VosOrderDetail [order_currency=" + order_currency
				+ ", transaction_date=" + transaction_date
				+ ", payment_currency=" + payment_currency + ", type=" + type
				+ ", status=" + status + ", units_traded=" + units_traded
