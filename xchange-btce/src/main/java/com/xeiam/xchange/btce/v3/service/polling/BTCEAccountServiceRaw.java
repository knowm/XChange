...
public class BTCEAccountServiceRaw extends BTCEBasePollingService<BTCEAuthenticated> {
   ...
   * @return BTCEAccountInfo object: {funds={usd=0, rur=0, eur=0, btc=0.1,
   *         ltc=0, nmc=0}, rights={info=1, trade=1, withdraw=1},
   *         transaction_count=1, open_orders=0, server_time=1357678428}
   */
