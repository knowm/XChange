...
public class BitMarketTestSupport extends BitMarketDtoTestSupport {
  ...
  public static final BitMarketOrder PARSED_TRADE_ORDER = new BitMarketOrder(
    31408L, "BTCPLN",new BigDecimal("0.50000000"), new BigDecimal("4000.0000"),
    new BigDecimal("2000.00000000"), "sell", 1432916922L);

  public static final BitMarketBalance PARSED_TRADE_BALANCE = new BitMarketBalance(
    createParsedTradeAvailable(), createParsedTradeBlocked());
  ...
  public static final OrderBook ORDER_BOOK = new OrderBook(null,
    Arrays.asList(
      new LimitOrder(Order.OrderType.ASK, new BigDecimal("20.47"),
        CurrencyPair.BTC_AUD, null, null, new BigDecimal("14.6999")),
      new LimitOrder(Order.OrderType.ASK, new BigDecimal("10.06627287"),
        CurrencyPair.BTC_AUD, null, null, new BigDecimal("14.7"))
    ),
    Arrays.asList(
      new LimitOrder(Order.OrderType.BID, new BigDecimal("1.55"),
        CurrencyPair.BTC_AUD, null, null, new BigDecimal("14.4102")),
      new LimitOrder(Order.OrderType.BID, new BigDecimal("27.77224019"),
        CurrencyPair.BTC_AUD, null, null, new BigDecimal("14.4101")),
      new LimitOrder(Order.OrderType.BID, new BigDecimal("52669.33019064"),
        CurrencyPair.BTC_AUD, null, null, new BigDecimal("0"))
    ));

  public static final BitMarketTicker PARSED_TICKER = new BitMarketTicker(
    new BigDecimal("1794.5000"), new BigDecimal("1789.2301"), new BigDecimal("1789.2001"),
    new BigDecimal("1756.5000"), new BigDecimal("1813.5000"), new BigDecimal("1785.8484"),
