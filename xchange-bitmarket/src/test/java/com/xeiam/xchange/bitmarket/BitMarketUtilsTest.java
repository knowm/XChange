...
public class BitMarketUtilsTest {
  ...
  public void shouldConvertStringToCurrencyPair() {
    ...
    assertThat(BitMarketUtils.BitMarketCurrencyPairToCurrencyPair("LiteMineXBTC")).isEqualTo(new CurrencyPair("LiteMineX", "BTC"));
  ...
  public void shouldConvertCurrencyPairToString() {
    ...
    assertThat(BitMarketUtils.CurrencyPairToBitMarketCurrencyPair(new CurrencyPair("LiteMineX", "BTC"))).isEqualTo("LiteMineXBTC");
