...
public class BitMarketDtoTest extends BitMarketTestSupport {
  ...
  public void shouldParseCancelOrder() throws IOException {
    // when
    BitMarketCancelResponse response = parse("org/knowm/xchange/bitmarket/dto/trade/example-cancel-order", BitMarketCancelResponse.class);
  ...
  public void shouldParseDeposit() throws IOException {
    // when
    BitMarketDepositResponse response = parse("org/knowm/xchange/bitmarket/dto/account/example-deposit-data", BitMarketDepositResponse.class);
  ...
  public void shouldParseWithdraw() throws IOException {
    // when
    BitMarketWithdrawResponse response = parse("org/knowm/xchange/bitmarket/dto/account/example-withdraw-data", BitMarketWithdrawResponse.class);
  ...
  public void shouldParseMarketTrade() throws IOException {
    // when
    BitMarketTradeResponse response = parse("org/knowm/xchange/bitmarket/dto/trade/example-trade-data", BitMarketTradeResponse.class);
  ...
  public void shouldParseOrderBook() throws IOException {
    // when
    BitMarketOrderBook response = parse("org/knowm/xchange/bitmarket/dto/marketdata/example-order-book-data", BitMarketOrderBook.class);
  ...
  public void shouldParseTicker() throws IOException {
    // when
    BitMarketTicker response = parse("org/knowm/xchange/bitmarket/dto/marketdata/example-ticker-data", BitMarketTicker.class);
  ...
  public void shouldParseTrades() throws IOException {
    ...
    // when
    BitMarketTrade[] trades = parse("org/knowm/xchange/bitmarket/dto/marketdata/example-trades-data", BitMarketTrade[].class);
