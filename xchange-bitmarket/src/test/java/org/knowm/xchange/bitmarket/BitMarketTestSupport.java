...
public class BitMarketTestSupport extends BitMarketDtoTestSupport {
  ...
  public static final BitMarketBalance PARSED_BALANCE =
      new BitMarketBalance(createParsedAvailable(), createParsedBlocked());
  public static final BitMarketOrder PARSED_TRADE_ORDER =
      new BitMarketOrder(
          31408L,
          "BTCPLN",
          ...
          "sell",
          1432916922L);
  public static final BitMarketBalance PARSED_TRADE_BALANCE =
      new BitMarketBalance(createParsedTradeAvailable(), createParsedTradeBlocked());
  public static final BitMarketOrderBook PARSED_ORDER_BOOK =
      new BitMarketOrderBook(
          new BigDecimal[][] {
            new BigDecimal[] {new BigDecimal("14.6999"), new BigDecimal("20.47")},
            new BigDecimal[] {new BigDecimal("14.7"), new BigDecimal("10.06627287")}
          },
          new BigDecimal[][] {
            new BigDecimal[] {new BigDecimal("14.4102"), new BigDecimal("1.55")},
  ...
  public static final OrderBook ORDER_BOOK =
      new OrderBook(
          null,
          Arrays.asList(
              new LimitOrder(
                  Order.OrderType.ASK,
                  new BigDecimal("20.47"),
                  CurrencyPair.BTC_AUD,
                  null,
                  null,
                  new BigDecimal("14.6999")),
              new LimitOrder(
                  Order.OrderType.ASK,
                  new BigDecimal("10.06627287"),
                  CurrencyPair.BTC_AUD,
                  null,
                  null,
                  new BigDecimal("14.7"))),
          Arrays.asList(
              new LimitOrder(
                  ...
                  null,
                  null,
                  new BigDecimal("14.4102")),
              new LimitOrder(
                  Order.OrderType.BID,
                  new BigDecimal("27.77224019"),
                  CurrencyPair.BTC_AUD,
                  null,
                  null,
                  new BigDecimal("14.4101")),
              new LimitOrder(
                  Order.OrderType.BID,
                  new BigDecimal("52669.33019064"),
                  CurrencyPair.BTC_AUD,
                  null,
                  null,
                  new BigDecimal("0"))));
  public static final BitMarketTicker PARSED_TICKER =
      new BitMarketTicker(
          new BigDecimal("1794.5000"),
          new BigDecimal("1789.2301"),
          new BigDecimal("1789.2001"),
          new BigDecimal("1756.5000"),
          new BigDecimal("1813.5000"),
          new BigDecimal("1785.8484"),
          new BigDecimal("455.69192487"));
  public static final UserTrade EXPECTED_BM_USER_TRADES =
      new UserTrade(
          Order.OrderType.BID,
          new BigDecimal("0.08888888"),
          CurrencyPair.BTC_EUR,
          new BigDecimal("210.3333"),
  ...
  public static final Ticker TICKER =
      new Ticker.Builder()
          ...
          .ask(new BigDecimal("1794.5000"))
          .last(new BigDecimal("1789.2001"))
          .low(new BigDecimal("1756.5000"))
          .high(new BigDecimal("1813.5000"))
          .currencyPair(CurrencyPair.BTC_AUD)
          .vwap(new BigDecimal("1785.8484"))
          .volume(new BigDecimal("455.69192487"))
          .build();
  ...
  public static BitMarketTrade[] expectedParsedTrades() {
    return new BitMarketTrade[] {
      new BitMarketTrade(
          "78455", new BigDecimal("14.6900"), new BigDecimal("27.24579867"), 1450344119L, "ask"),
      new BitMarketTrade(
          "78454", new BigDecimal("14.4105"), new BigDecimal("5.22284399"), 1450343831L, "ask"),
      new BitMarketTrade(
          "78453", new BigDecimal("14.4105"), new BigDecimal("0.10560487"), 1450303414L, "ask")
    };
  }
  ...
  public static Trade[] expectedTrades() {
    return new Trade[] {
      new Trade(
          Order.OrderType.BID,
          new BigDecimal("0.10560487"),
          CurrencyPair.BTC_AUD,
          new BigDecimal("14.4105"),
          new Date(1450303414000L),
          "78453"),
      new Trade(
          Order.OrderType.BID,
          new BigDecimal("5.22284399"),
          CurrencyPair.BTC_AUD,
          new BigDecimal("14.4105"),
          new Date(1450343831000L),
          "78454"),
      new Trade(
          Order.OrderType.BID,
          new BigDecimal("27.24579867"),
          CurrencyPair.BTC_AUD,
          new BigDecimal("14.6900"),
          new Date(1450344119000L),
          "78455")
    };
  }
  ...
  public static UserTrade[] expectedUserTrades() {
    return new UserTrade[] {
      new UserTrade(
          ...
          CurrencyPair.BTC_PLN,
          new BigDecimal("875.9898"),
          new Date(1429901376000L),
          "386637",
          null,
          null,
          Currency.BTC),
      ...
      new UserTrade(
          ...
          new BigDecimal("0.50000000"),
          CurrencyPair.BTC_PLN,
          new BigDecimal("869.9900"),
          new Date(1429911236000L),
          "386651",
          null,
          null,
          Currency.BTC),
      new UserTrade(
          Order.OrderType.BID,
          new BigDecimal("0.03120150"),
          CurrencyPair.BTC_PLN,
          new BigDecimal("865.6667"),
          new Date(1429965622000L),
          "386750",
          null,
          null,
          Currency.BTC),
      new UserTrade(
          Order.OrderType.ASK,
          new BigDecimal("1.08260046"),
          CurrencyPair.BTC_PLN,
          new BigDecimal("877.0000"),
          new Date(1430687948000L),
          "389406",
          "11852566",
          new BigDecimal("0.30312011"),
          Currency.PLN)
    };
  }
  ...
  public static UserTrade[] expectedCpUserTrades() {
    return new UserTrade[] {
      ...
      new UserTrade(
          Order.OrderType.BID,
          new BigDecimal("0.05555555"),
          CurrencyPair.BTC_EUR,
          new BigDecimal("115.5555"),
          new Date(1400000000000L),
          "386750",
          null,
          null,
          Currency.BTC),
  ...
  protected static ExchangeSpecification createExchangeSpecification() {
    ExchangeSpecification specification =
        ExchangeFactory.INSTANCE
            .createExchange(BitMarketExchange.class.getCanonicalName())
