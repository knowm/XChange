...
public class BitMarketHistoryOperationsJSONTest extends BitMarketDtoTestSupport {
  ...
  public void testUnmarshal() throws IOException {
    // when
    BitMarketHistoryOperationsResponse response = parse("org/knowm/xchange/bitmarket/dto/trade/example-history-operations-data", BitMarketHistoryOperationsResponse.class);
