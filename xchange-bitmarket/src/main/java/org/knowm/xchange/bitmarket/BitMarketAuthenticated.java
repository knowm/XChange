...
public interface BitMarketAuthenticated {
  ...
  @POST
  @FormParam("method")
  BitMarketAccountInfoResponse info(
  ...
  @POST
  @FormParam("method")
  BitMarketWithdrawResponse withdraw(
      @HeaderParam("API-Key") String apiKey,
      @HeaderParam("API-Hash") ParamsDigest sign,
      @FormParam("tonce") SynchronizedValueFactory<Long> timestamp,
  ...
  @POST
  @FormParam("method")
  BitMarketDepositResponse deposit(
      @HeaderParam("API-Key") String apiKey,
      @HeaderParam("API-Hash") ParamsDigest sign,
      @FormParam("tonce") SynchronizedValueFactory<Long> timestamp,
      @FormParam("currency") String currency)
  ...
  @POST
  @FormParam("method")
  BitMarketOrdersResponse orders(
      @HeaderParam("API-Key") String apiKey,
      @HeaderParam("API-Hash") ParamsDigest sign,
      @FormParam("tonce") SynchronizedValueFactory<Long> timestamp)
      throws IOException;
  ...
  @POST
  @FormParam("method")
  BitMarketCancelResponse cancel(
      @HeaderParam("API-Key") String apiKey,
      @HeaderParam("API-Hash") ParamsDigest sign,
      @FormParam("tonce") SynchronizedValueFactory<Long> timestamp,
  ...
  @POST
  @FormParam("method")
  BitMarketHistoryTradesResponse trades(
      @HeaderParam("API-Key") String apiKey,
      @HeaderParam("API-Hash") ParamsDigest sign,
      @FormParam("tonce") SynchronizedValueFactory<Long> timestamp,
      @FormParam("market") String market,
