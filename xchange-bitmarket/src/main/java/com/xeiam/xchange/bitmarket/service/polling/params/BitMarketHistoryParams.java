package com.xeiam.xchange.bitmarket.service.polling.params;
...
public class BitMarketHistoryParams implements TradeHistoryParamCurrencyPair, TradeHistoryParamOffset {
  ...
  @Override public void setCurrencyPair(CurrencyPair currencyPair) {
    this.currencyPair = currencyPair;
  }
  ...
  @Override public void setOffset(Long offset) {
    this.offset = offset;
  }
