...
public class BitcointoyouAdaptersTest {
  ...
  public void testBalancesAdapter() throws Exception {
    ...
    softly
        .assertThat(balances)
        .contains(
            new Balance(Currency.BRL, new BigDecimal("8657.531311027634275"), null),
            new Balance(Currency.BTC, new BigDecimal("35.460074025529646"), null),
            new Balance(Currency.LTC, new BigDecimal("9.840918628667236"), null),
            new Balance(Currency.DOGE, new BigDecimal("5419.490003406479187"), null),
            new Balance(Currency.DRK, new BigDecimal("0.121461143982142"), null));
