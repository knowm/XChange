...
public class BitcoinToYouTicker {
  ...
  private final BitcoinToYouTicker.Ticker ticker;

  public BitcoinToYouTicker(@JsonProperty("ticker") BitcoinToYouTicker.Ticker ticker) {
  ...
  public String toString() {
    ...
    return "BitcoinToYouTicker [ticker=" + ticker + "]";
  }
