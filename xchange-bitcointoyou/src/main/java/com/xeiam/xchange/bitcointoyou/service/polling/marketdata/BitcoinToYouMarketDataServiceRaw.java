...
public class BitcoinToYouMarketDataServiceRaw extends BitcoinToYouBasePollingService {
   ...
   */
  public BitcoinToYouMarketDataServiceRaw(ExchangeSpecification exchangeSpecification) {

    super(exchangeSpecification);
    this.bitcoinToYou = RestProxyFactory.createProxy(BitcoinToYou.class, exchangeSpecification.getSslUri());
  }
