...
public class SerumAdapters {
    ...
    /**
     * Serum represents markets as individual Solana addresses. As part of starting up the
     * the scaffold for Serum we load all the "markets" from the REST api and associate
     * currency pairs to their addresses and metadata.
     *
     * The markets file maintained in XChange should mirror the one found:
