  ...
  protected void initServices() {
    this.blockchain =
        ExchangeRestProxyBuilder.forInterface(
                BlockchainAuthenticated.class, this.getExchangeSpecification())
            .clientConfigCustomizer(
                clientConfig -> {
                  clientConfig.addDefaultParam(
                      HeaderParam.class,
                      X_API_TOKEN,
    ...
    this.accountService =
        new BlockchainAccountService(this, this.blockchain, this.getResilienceRegistries());
    this.tradeService =
        new BlockchainTradeService(this, this.blockchain, this.getResilienceRegistries());
    this.marketDataService =
        new BlockchainMarketDataService(this, this.blockchain, this.getResilienceRegistries());
  }

  @Override
  public void remoteInit() throws IOException, ExchangeException {
    BlockchainAccountServiceRaw dataService = (BlockchainAccountServiceRaw) this.accountService;
