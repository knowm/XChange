...
public class CustomCurrencyPairSerializer extends JsonSerializer<CurrencyPair> {
  ...
  @Override
  public void serialize(CurrencyPair currencyPair, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException, JsonProcessingException {
