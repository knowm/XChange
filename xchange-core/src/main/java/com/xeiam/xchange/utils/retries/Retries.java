...
public class Retries {
   ...
   * exponentially. For examples: @see {@link com.xeiam.xchange.examples.core.utils.RetriesDemo}
   * 
   ...
   * @param retryableException An instance of {@link com.xeiam.xchange.utils.retries.IPredicate} that will be used to check if the exception caught is
