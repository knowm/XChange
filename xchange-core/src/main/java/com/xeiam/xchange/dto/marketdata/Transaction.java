...
public class Transaction {
    ...
    /**
     * @param type
     *          The transaction type (BID,ASK,WITHDRAWAL,DEPOSIT)
     ...
     */
    public Transaction(TransactionType type, BigDecimal tradableAmount, CurrencyPair currencyPair, BigDecimal price, Date timestamp, String id, String orderId) {
     ...
     *          The id of the trade
     */
    public Transaction(TransactionType type, BigDecimal tradableAmount, CurrencyPair currencyPair, BigDecimal price, Date timestamp, String id) {
