 ...
 * e.g. "1657444151.611" is converted to "Sun Jul 10 11:09:11 CEST 2022"
 */
public class UnixTimestampNanoSecondsDeserializer extends JsonDeserializer<Date> {
  ...
  public Date deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
    ...
    long valueWithMilliseconds = new BigDecimal(value).multiply(BigDecimal.valueOf(1000)).longValue();
