...
public interface ItBitAuthenticated {
  ...
  @Path("wallets")
  @Consumes(MediaType.APPLICATION_JSON)
  List wallets(@HeaderParam("Authorization") ParamsDigest signatureCreator, @HeaderParam("X-Auth-Nonce") SynchronizedValueFactory<Long> nonceFactory,
      @HeaderParam("X-Auth-Timestamp") long timestamp, @QueryParam("userId") String userId, @QueryParam("page") int page,
      @QueryParam("perPage") int perPage);

  @GET
  @Path("wallets/{walletId}/funding_history")
  @Consumes(MediaType.APPLICATION_JSON)
  ItBitFundingHistoryResponse fundingHistory(@HeaderParam("Authorization") ParamsDigest signatureCreator,
      @HeaderParam("X-Auth-Nonce") SynchronizedValueFactory<Long> nonceFactory, @HeaderParam("X-Auth-Timestamp") long timestamp,
