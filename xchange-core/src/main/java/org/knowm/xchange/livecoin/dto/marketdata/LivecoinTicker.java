...
public class LivecoinTicker {
  ...
  public LivecoinTicker(@JsonProperty("cur") String cur, @JsonProperty("symbol") String symbol, @JsonProperty("last") BigDecimal last,
      @JsonProperty("high") BigDecimal high, @JsonProperty("low") BigDecimal low, @JsonProperty("volume") BigDecimal volume,
      @JsonProperty("vwap") BigDecimal vwap, @JsonProperty("max_bid") BigDecimal maxBid, @JsonProperty("min_ask") BigDecimal minAsk,
  ...
  public String toString() {
    return "LivecoinTicker{" + "cur=" + cur + ", symbol=" + symbol + ", last=" + last + ", high=" + high + ", low=" + low + ", volume=" + volume
        + ", vwap=" + vwap + ", maxBid=" + maxBid + ", minAsk=" + minAsk + ", bestBid=" + bestBid + ", bestAsk=" + bestAsk + '}';
  }
}
