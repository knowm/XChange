...
public class IndependentReservePlaceLimitOrderRequest extends AuthAggregate {
  ...
  public IndependentReservePlaceLimitOrderRequest(String apiKey, Long nonce, String primaryCurrencyCode, String secondaryCurrencyCode,
      String orderType, String price, String volume) {
    super(apiKey, nonce);
