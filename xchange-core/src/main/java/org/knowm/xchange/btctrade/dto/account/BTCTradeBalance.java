...
public class BTCTradeBalance extends BTCTradeResult {
  ...
  public BTCTradeBalance(@JsonProperty("result") Boolean result, @JsonProperty("message") String message, @JsonProperty("uid") Long uid,
      @JsonProperty("nameauth") Integer nameauth, @JsonProperty("moflag") String moflag, @JsonProperty("btc_balance") BigDecimal btcBalance,
      @JsonProperty("btc_reserved") BigDecimal btcReserved, @JsonProperty("ltc_balance") BigDecimal ltcBalance,
      @JsonProperty("ltc_reserved") BigDecimal ltcReserved, @JsonProperty("doge_balance") BigDecimal dogeBalance,
      @JsonProperty("doge_reserved") BigDecimal dogeReserved, @JsonProperty("ybc_balance") BigDecimal ybcBalance,
      @JsonProperty("ybc_reserved") BigDecimal ybcReserved, @JsonProperty("cny_balance") BigDecimal cnyBalance,
