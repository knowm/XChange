...
public class BitcoindeTradesWrapper extends BitcoindeResponse {
  ...
  public BitcoindeTradesWrapper(@JsonProperty("trades") BitcoindeTrade[] trades, @JsonProperty("credits") int credits,
  ...
  public String toString() {
    return "BitcoindeTradesWrapper{" + "trades=" + Arrays.toString(trades) + "} " + super.toString();
  }
}
