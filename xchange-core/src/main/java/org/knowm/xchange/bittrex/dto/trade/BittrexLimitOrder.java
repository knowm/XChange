...
public class BittrexLimitOrder extends LimitOrder {
  ...
  public BittrexLimitOrder(OrderType type, BigDecimal originalAmount, CurrencyPair currencyPair, String id, Date timestamp, BigDecimal limitPrice,
    ...
    super(type, originalAmount, quantityRemaining == null ? null : originalAmount.subtract(quantityRemaining), currencyPair, id, timestamp,
        limitPrice);
  ...
  public BittrexLimitOrder(OrderType type, BigDecimal originalAmount, CurrencyPair currencyPair, String id, Date timestamp, BigDecimal limitPrice,
    ...
    super(type, originalAmount, currencyPair, id, timestamp, limitPrice, pricePerUnit,
        quantityRemaining == null ? null : originalAmount.subtract(quantityRemaining), fee, status);
