...
@JsonPropertyOrder({"totalBalance", "balance", "freeze", "id", "symbol", "icon_url", "describe_url", "name", "enable_withdraw", "enable_deposit",
    "confirm_count", "BTCValue", "CNYValue", "USDValue"})
