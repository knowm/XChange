...
@JsonPropertyOrder({"createdAt", "amount", "dealValue", "dealPrice", "fee", "feeRate", "oid", "orderOid", "coinType", "coinTypePair", "direction",
    "dealDirection"})
public class KucoinDealtOrder {
   ...
   * @param direction
   */
  public KucoinDealtOrder(Long createdAt, BigDecimal amount, BigDecimal dealValue, BigDecimal dealPrice, BigDecimal fee, BigDecimal feeRate,
      String oid, String orderOid, String coinType, String coinTypePair, KucoinOrderType direction, KucoinOrderType dealDirection) {
    super();
