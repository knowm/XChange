...
@JsonPropertyOrder({"withdrawMinFee", "withdrawMinAmount", "withdrawFeeRate", "confirmationCount", "withdrawRemark", "infoUrl", "name",
    "tradePrecision", "depositRemark", "enableWithdraw", "enableDeposit", "coin"})
public class KucoinCoin {
   ...
   * @param coin
   */
  public KucoinCoin(BigDecimal withdrawMinFee, BigDecimal withdrawMinAmount, BigDecimal withdrawFeeRate, Integer confirmationCount,
      String withdrawRemark, Object infoUrl, String name, Integer tradePrecision, String depositRemark, Boolean enableWithdraw, Boolean enableDeposit,
      String coin) {
    super();
