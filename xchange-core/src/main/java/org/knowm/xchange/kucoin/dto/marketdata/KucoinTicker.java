...
@JsonPropertyOrder({"coinType", "trading", "symbol", "lastDealPrice", "buy", "sell", "change", "coinTypePair", "sort", "feeRate", "volValue", "high",
    "datetime", "vol", "low", "changeRate"})
public class KucoinTicker {
   ...
   * @param changeRate
   */
  public KucoinTicker(String coinType, Boolean trading, String symbol, BigDecimal lastDealPrice, BigDecimal buy, BigDecimal sell, BigDecimal change,
      String coinTypePair, Integer sort, BigDecimal feeRate, BigDecimal volValue, BigDecimal high, Long datetime, BigDecimal vol, BigDecimal low,
