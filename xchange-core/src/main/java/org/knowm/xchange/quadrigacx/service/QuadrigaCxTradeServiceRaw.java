...
public class QuadrigaCxTradeServiceRaw extends QuadrigaCxBaseService {
  ...
  public QuadrigaCxTradeServiceRaw(Exchange exchange) {
    ...
    super(exchange);
    this.quadrigacxAuthenticated = RestProxyFactory
        .createProxy(QuadrigaCxAuthenticated.class, exchange.getExchangeSpecification().getSslUri(), getClientConfig());
    this.signatureCreator = QuadrigaCxDigest
  ...
  public QuadrigaCxOrder[] getQuadrigaCxOpenOrders(CurrencyPair currencyPair) throws IOException {
    ...
    return quadrigacxAuthenticated
        .getOpenOrders(QuadrigaCxUtils.currencyPairToBook(currencyPair), exchange.getExchangeSpecification().getApiKey(), signatureCreator,
  ...
  public QuadrigaCxOrder sellQuadrigaCxOrder(CurrencyPair currencyPair, BigDecimal originalAmount, BigDecimal price) throws IOException {
    ...
    return quadrigacxAuthenticated
        .sell(QuadrigaCxUtils.currencyPairToBook(currencyPair), exchange.getExchangeSpecification().getApiKey(), signatureCreator,
            exchange.getNonceFactory(), originalAmount, price);
  }
  ...
  public QuadrigaCxOrder buyQuadrigaCxOrder(CurrencyPair currencyPair, BigDecimal originalAmount, BigDecimal price) throws IOException {
    ...
    return quadrigacxAuthenticated
        .buy(QuadrigaCxUtils.currencyPairToBook(currencyPair), exchange.getExchangeSpecification().getApiKey(), signatureCreator,
            exchange.getNonceFactory(), originalAmount, price);
  }
  ...
  public QuadrigaCxOrder sellQuadrigaCxOrder(CurrencyPair currencyPair, BigDecimal originalAmount) throws IOException {
    ...
    return quadrigacxAuthenticated
        .sell(QuadrigaCxUtils.currencyPairToBook(currencyPair), exchange.getExchangeSpecification().getApiKey(), signatureCreator,
            exchange.getNonceFactory(), originalAmount, null);
  }
  ...
  public QuadrigaCxUserTransaction[] getQuadrigaCxUserTransactions(CurrencyPair currencyPair, Long numberOfTransactions, Long offset, String sort)
      throws IOException {

    return quadrigacxAuthenticated
        .getUserTransactions(QuadrigaCxUtils.currencyPairToBook(currencyPair), exchange.getExchangeSpecification().getApiKey(), signatureCreator,
            exchange.getNonceFactory(), numberOfTransactions, offset, sort);
  }
