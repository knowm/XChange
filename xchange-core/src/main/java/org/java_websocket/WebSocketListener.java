...
/**
 * Implemented by <tt>WebSocketClient</tt> and <tt>WebSocketServer</tt>. The methods within are called by <tt>WebSocket</tt>. Almost every method takes a first parameter conn which represents the
 * source of the respective event.
 */
public interface WebSocketListener {

  /**
   * Called on the server side when the socket connection is first established, and the WebSocket handshake has been received. This method allows to deny connections based on the received handshake.<br>
  ...
  /**
   * Called after <var>onHandshakeReceived</var> returns <var>true</var>. Indicates that a complete WebSocket connection has been established, and we are ready to send/receive data.
   * 
