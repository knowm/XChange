...
public final class OrderBookOld implements Serializable {
   ...
   */
  public OrderBookOld(
      Date timeStamp, Stream<LimitOrder> asks, Stream<LimitOrder> bids, boolean sort) {
  ...
  public boolean equals(Object obj) {
    ...
    final org.knowm.xchange.dto.marketdata.OrderBookOld other =
        (org.knowm.xchange.dto.marketdata.OrderBookOld) obj;
  ...
  public boolean ordersEqual(org.knowm.xchange.dto.marketdata.OrderBook ob) {
    ...
    org.knowm.xchange.dto.marketdata.OrderBook thisOb =
        new org.knowm.xchange.dto.marketdata.OrderBook(timestamp, this.getAsks(), this.getBids());
    org.knowm.xchange.dto.marketdata.OrderBook thatOb =
        new org.knowm.xchange.dto.marketdata.OrderBook(timestamp, ob.getAsks(), ob.getBids());
