...
public class RippleOrderTest {
  ...
  public void orderEntryResponseUnmarshalTest() throws IOException {
    ...
    final InputStream is = getClass().getResourceAsStream("/org/knowm/xchange/ripple/dto/trade/example-order-entry-response.json");
  ...
  public void orderCancelResponseUnmarshalTest() throws IOException {
    // Read in the JSON from the example resources
    final InputStream is = getClass().getResourceAsStream("/org/knowm/xchange/ripple/dto/trade/example-order-cancel-response.json");
    final ObjectMapper mapper = new ObjectMapper();
  ...
  public void orderTransactionUnmarshalTest() throws IOException, ParseException {
    // Read in the JSON from the example resources
    final InputStream is = getClass().getResourceAsStream("/org/knowm/xchange/ripple/dto/trade/example-order-details.json");
    final ObjectMapper mapper = new ObjectMapper();
