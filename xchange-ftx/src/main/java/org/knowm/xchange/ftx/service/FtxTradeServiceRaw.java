...
public class FtxTradeServiceRaw extends FtxBaseService {
  ...
  public FtxResponse<FtxOrderDto> placeNewFtxOrder(String subAccount, FtxOrderRequestPayload payload)
  ...
  public boolean cancelAllFtxOrders(CancelAllFtxOrdersParams payLoad) throws FtxException,IOException{
    try{
  ...
  public FtxResponse<List<FtxOrderDto>> getFtxOpenOrders(CurrencyPair currencyPair) throws FtxException,IOException{
    try{
  ...
  public FtxResponse<List<FtxOrderDto>> getFtxOrderHistory(Instrument instrument) throws FtxException,IOException{
    try{
