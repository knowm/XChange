...
//	private final Date expiry;
	...
	@JsonCreator
	public FtxConvertDto(@JsonProperty(value= "baseCoin", required = false) String baseCoin,
	...
	public String toString() {
		return "FtxConvertDto [baseCoin=" + baseCoin + ", cost=" + cost + ", expired=" + expired + ", filled=" + filled + ", fromCoin=" + fromCoin + ", id=" + id + ", price=" + price + ", proceeds=" + proceeds + ", quoteCoin=" + quoteCoin + ", side=" + side + ", toCoin=" + toCoin + "]";
	}
