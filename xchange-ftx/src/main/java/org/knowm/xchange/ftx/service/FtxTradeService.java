...
public class FtxTradeService extends FtxTradeServiceRaw implements TradeService {
  ...
  public String placeLimitOrder(LimitOrder limitOrder) throws IOException {
    return placeNewFtxOrder(null, FtxAdapters.adaptLimitOrderToFtxOrderPayload(limitOrder)).getResult().getId();
  }
  ...
  public UserTrades getTradeHistory(TradeHistoryParams params) throws IOException {
    ...
    if(params instanceof TradeHistoryParamCurrencyPair){
      return FtxAdapters.adaptUserTrades(getFtxOrderHistory(((TradeHistoryParamCurrencyPair) params).getCurrencyPair()).getResult());
    }
    else if(params instanceof TradeHistoryParamInstrument){
      return FtxAdapters.adaptUserTrades(getFtxOrderHistory(((TradeHistoryParamInstrument) params).getInstrument()).getResult());
    }
    else {
  ...
  public boolean cancelOrder(CancelOrderParams orderParams) throws IOException {
    if(orderParams instanceof CancelOrderByCurrencyPair){
      return cancelAllFtxOrders(new CancelAllFtxOrdersParams(((CancelOrderByCurrencyPair) orderParams).getCurrencyPair().toString()));
    }else {
  ...
  public OpenOrders getOpenOrders(OpenOrdersParams params) throws IOException {
    if(params instanceof CurrencyPairParam){
      return FtxAdapters.adaptOpenOrders(getFtxOpenOrders(((CurrencyPairParam) params).getCurrencyPair()));
    }else {
