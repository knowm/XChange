...
public class FtxOrderRequestPOJO {
    ...
    public FtxOrderRequestPOJO(String market, FtxOrderSide side,BigDecimal price, FtxOrderType type, BigDecimal size, boolean reduceOnly, boolean ioc, boolean postOnly, String cliendId) {
        this.market = market;
        this.side = side;
        this.price = price;
        this.type = type;
