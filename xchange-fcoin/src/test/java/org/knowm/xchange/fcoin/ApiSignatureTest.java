...
public class ApiSignatureTest {
    ...
    public void testSignature() {
        ...
        writerResolver.addWriter("application/json", new RequestWriter() {
            @Override
        ...
        String signature = digest.digestParams(new RestInvocation(paramsMap, Collections.emptyList(), new RestMethodMetadata(null, HttpMethod.POST, null, null, null, null, "application/json", "application/json", null, null, null), "api.fcoin.com/v2/orders", "https://api.fcoin.com/v2/orders", "", "/v2/orders", writerResolver));
