...
public class ApiSignatureTest {
  ...
  public void testSignature() {
    ...
    writerResolver.addWriter(
        "application/json",
        new JacksonRequestWriter(new ObjectMapper())
    );

    HeaderParam headerParamAnn = new HeaderParam() {
      @Override public Class<? extends Annotation> annotationType() { return HeaderParam.class; }
      @Override public String value() { return "FC-ACCESS-TIMESTAMP"; }
    };
    String signature =
        digest.digestParams(
