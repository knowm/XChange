...
public class FCoinDigest extends BaseParamsDigest {
    ...
    public String digestParams(RestInvocation restInvocation) {
        ...
        String timestamp = restInvocation.getParamValue(HeaderParam.class, "FC-ACCESS-TIMESTAMP").toString();
        String payload = method + uri + timestamp + bodyQuery;
        return DatatypeConverter.printBase64Binary(getMac().doFinal(DatatypeConverter.printBase64Binary(payload.getBytes()).getBytes()));
    }
}
