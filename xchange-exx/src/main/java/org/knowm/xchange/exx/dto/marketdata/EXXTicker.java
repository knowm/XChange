...
public class EXXTicker extends EXXTickerResponse {
         ...
         * @param monthRiseRate
         */
        public EXXTicker(BigDecimal vol, BigDecimal last, BigDecimal sell, BigDecimal buy, BigDecimal weekRiseRate, BigDecimal riseRate, BigDecimal high, BigDecimal low, BigDecimal monthRiseRate) {
            super();
            this.vol = vol;
            this.last = last;
            this.sell = sell;
