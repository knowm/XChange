...
public class EXXBalance {
     ...
     * @param fundsType
     */
    public EXXBalance(BigDecimal total, BigDecimal freeze, BigDecimal balance, String fundsType, String propTag, BigDecimal creditQuota, BigDecimal creditBorrowed, BigDecimal creditInterest) {
        super();
        this.total = total;
        this.freeze = freeze;
