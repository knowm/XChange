...
public interface EXXAuthenticated extends EXX {
  ...
  //accesskey=accesskey&amount=1.5&currency=eth_hsr&nonce=Current time in milliseconds&price=1024&type=buy  
  @GET
  @Path("order")
  ...
  /**
   * accesskey=your_access_key&currency=eth_hsr&nonce=Current time in milliseconds&pageIndex=1&type=buy
   * 
   * @param apiKey
   * @param signature
   * @param market
