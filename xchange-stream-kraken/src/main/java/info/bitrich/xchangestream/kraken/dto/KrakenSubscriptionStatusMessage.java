...
public class KrakenSubscriptionStatusMessage extends KrakenEvent {
    ...
    @JsonCreator
    public KrakenSubscriptionStatusMessage(@JsonProperty("event") KrakenEventType event, @JsonProperty("channelID") Integer channelID,
                                           @JsonProperty("reqid") Integer reqid, @JsonProperty("status") KrakenSubscriptionStatus status,
                                           @JsonProperty("pair") String pair, @JsonProperty("subscription") KrakenSubscriptionConfig krakenSubscriptionConfig,
