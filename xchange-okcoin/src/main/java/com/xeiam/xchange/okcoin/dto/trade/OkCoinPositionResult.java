...
public class OkCoinPositionResult extends OkCoinErrorResult {
  ...
  public OkCoinPositionResult(@JsonProperty("result") final boolean result, @JsonProperty("errorCode") final int errorCode, @JsonProperty("holding") final OkCoinPosition[] positions) {
