...
public class CoindcxBaseService extends BaseExchangeService implements BaseService {
	...
	protected CoindcxBaseService(Exchange exchange) {
		super(exchange);
		coindcx = RestProxyFactory.createProxy(Coindcx.class, exchange.getExchangeSpecification().getSslUri(),
				getClientConfig());
		
		 this.apiKey = exchange.getExchangeSpecification().getApiKey();
		 this.signatureCreator = CoindcxHmacPostBodyDigest.createInstance(exchange.getExchangeSpecification().getSecretKey());
