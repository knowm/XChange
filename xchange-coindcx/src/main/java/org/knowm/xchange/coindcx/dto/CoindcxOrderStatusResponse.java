...
public class CoindcxOrderStatusResponse {
	...
	public CoindcxOrderStatusResponse(@JsonProperty("id") UUID id, @JsonProperty("market") String market,
			@JsonProperty("order_type") String order_type, @JsonProperty("side") String side,
			@JsonProperty("status") String status, @JsonProperty("fee_amount") BigDecimal fee_amount,
			@JsonProperty("fee") BigDecimal fee, @JsonProperty("total_quantity") BigDecimal total_quantity,
			@JsonProperty("remaining_quantity") BigDecimal remaining_quantity,
			@JsonProperty("avg_price") BigDecimal avg_price, @JsonProperty("price_per_unit") BigDecimal price_per_unit,
	...
	public String toString() {
		return "CoindcxOrderStatusResponse [id=" + id + ", market=" + market + ", order_type=" + order_type + ", side="
				+ side + ", status=" + status + ", fee_amount=" + fee_amount + ", fee=" + fee + ", total_quantity="
				+ total_quantity + ", remaining_quantity=" + remaining_quantity + ", avg_price=" + avg_price
				+ ", price_per_unit=" + price_per_unit + ", created_at=" + created_at + ", updated_at=" + updated_at
				+ "]";
	}
