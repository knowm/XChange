...
public class GeminiOrderStatusResponse {
   ...
   */
  public GeminiOrderStatusResponse(@JsonProperty("order_id") long id, @JsonProperty("exchange") String exchange,
      @JsonProperty("symbol") String symbol, @JsonProperty("price") BigDecimal price,
      @JsonProperty("avg_execution_price") BigDecimal avgExecutionPrice, @JsonProperty("side") String side, @JsonProperty("type") String type,
      @JsonProperty("timestamp") String timestamp, @JsonProperty("timestampms") long timestampms, @JsonProperty("is_live") boolean isLive,
