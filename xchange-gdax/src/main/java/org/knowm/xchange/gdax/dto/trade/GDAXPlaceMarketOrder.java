...
public class GDAXPlaceMarketOrder extends GDAXPlaceOrder {
  ...
  public GDAXPlaceMarketOrder(String clientOld, Type type, Side side, String productId, SelfTradePrevention stp,
                              Stop stop, BigDecimal stopPrice, BigDecimal size, BigDecimal funds) {
  ...
  public static class Builder extends GDAXPlaceOrder.Builder<GDAXPlaceMarketOrder, Builder> {
    ...
    public GDAXPlaceMarketOrder build() {
      return new GDAXPlaceMarketOrder(clientOid, type, side, productId, stp,
                                      stop, stopPrice, size, funds);
    }
  }
}
