...
public class GDAXMarketDataService extends GDAXMarketDataServiceRaw implements MarketDataService {
  ...
  public Ticker getTicker(CurrencyPair currencyPair, Object... args) throws IOException {
    ...
    // Request data
    GDAXProductTicker ticker = getCoinbaseExProductTicker(currencyPair);
    GDAXProductStats stats = getCoinbaseExProductStats(currencyPair);
  ...
  public OrderBook getOrderBook(CurrencyPair currencyPair, Object... args) throws IOException {
    ...
    return GDAXAdapters.adaptOrderBook(getCoinbaseExProductOrderBook(currencyPair, level), currencyPair);
  }
