...
public class GDAXPlaceLimitOrder extends GDAXPlaceOrder {
  ...
  public GDAXPlaceLimitOrder(String clientOld, Type type, Side side, String productId, SelfTradePrevention stp,
                             Stop stop, BigDecimal stopPrice, BigDecimal price, BigDecimal size,
                             TimeInForce timeInForce, CancelAfter cancelAfter, Boolean postOnly) {
  ...
  public static class Builder extends GDAXPlaceOrder.Builder<GDAXPlaceLimitOrder, Builder> {
    ...
    public GDAXPlaceLimitOrder build() {
      return new GDAXPlaceLimitOrder(clientOid, type, side, productId, stp,
                                     stop, stopPrice, price, size,
                                     timeInForce, cancelAfter, postOnly);
    }
  }
