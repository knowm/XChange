...
public class GDAXExchangeIntegration {
  ...
  public void testExtendedGetTrades() throws IOException {
	  ...
	  // get latest trades
	  GDAXTrades trades1 = marketDataServiceRaw.getGDAXTradesExtended(currencyPair, new Long(Integer.MAX_VALUE), null);  
//	  System.out.println(trades1);
	  assertEquals("Unexpected trades list length (100)", 100, trades1.size());
	  
	  // get latest 10 trades
	  GDAXTrades trades2 = marketDataServiceRaw.getGDAXTradesExtended(currencyPair, new Long(Integer.MAX_VALUE), 10);  
