...
public class DeribitAdaptersTest {
    ...
    public void adaptOrderBook() throws IOException {
        ...
        assertThat(orderBook.getBids().get(0).getCurrencyPair()).isEqualTo(new CurrencyPair("BTC","PERPETUAL"));
        ...
        assertThat(orderBook.getBids().get(1).getOriginalAmount()).isEqualTo(new BigDecimal("102020.0"));
        assertThat(orderBook.getBids().get(1).getCurrencyPair()).isEqualTo(new CurrencyPair("BTC","PERPETUAL"));
        ...
        assertThat(orderBook.getBids().get(2).getCurrencyPair()).isEqualTo(new CurrencyPair("BTC","PERPETUAL"));
