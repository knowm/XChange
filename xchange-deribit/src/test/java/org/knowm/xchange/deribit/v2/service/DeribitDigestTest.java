...
class DeribitDigestTest {
  ...
  @Test
  void signature_path() {
    DeribitDigest bitgetDigest =
        DeribitDigest.createDeribitAuth("id", "secret", new LongValueIncFactory());
    ...
    String expected =
        "deri-hmac-sha256 id=id,ts=1763296256773,sig=dd3eb83ab5101101cb37551e473fb22dcffb5db4c9e831acd8a9773e8924df9e,nonce=1763296256774";
  ...
  void signature_path_query() {
    ...
    String actual = bitgetDigest.digestParams(restInvocation);
    String expected =
        "deri-hmac-sha256 id=id,ts=1763296256773,sig=29e8d4f59a20193bce58cecbeb4497415fe987fc344733645e15c5195dbdd16e,nonce=1763296256774";
