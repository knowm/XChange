...
public enum OrderFlags implements IOrderFlags {
  /**
   * If true, the order is considered post-only. If the new price would cause the order to be
   * filled immediately (as taker), the price will be changed to be just below the spread.
   * <p>
