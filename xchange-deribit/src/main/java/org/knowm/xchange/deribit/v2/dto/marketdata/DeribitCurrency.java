...
public class DeribitCurrency {
    ...
    @JsonProperty("coin_type") public String coinType;
    @JsonProperty("currency") public String currency;
    @JsonProperty("currency_long") public String currencyLong;
    @JsonProperty("disabled_deposit_address_creation") public boolean disabledDepositAddressCreation;
    @JsonProperty("fee_precision") public int feePrecision;
