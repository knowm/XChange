...
public class Bl3pUtils {
    ...
    public static final long toSatoshi(BigDecimal bd) { return bd.multiply(SATOSHI).longValue(); }

    public static final BigDecimal fromEuroshi(BigDecimal bd) {
        return bd.divide(EUROSHI);
    }
    public static final long toEuroshi(BigDecimal bd) { return bd.multiply(EUROSHI).longValue(); }
    ...
    public static String toBl3pOrderType(Order.OrderType orderType) {
        switch (orderType) {
            case BID: return "bid";
            case ASK: return "ask";
            case EXIT_ASK: return "exit_ask";
            case EXIT_BID: return "exit_bid";
            default: return null;
        }
    }
}
