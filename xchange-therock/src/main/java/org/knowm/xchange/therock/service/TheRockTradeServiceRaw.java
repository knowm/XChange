...
public class TheRockTradeServiceRaw extends TheRockBaseService {
  ...
  public TheRockOrder placeTheRockOrder(
    ...
    return placeTheRockOrder(
        currencyPair, new TheRockOrder(new TheRock.Pair(currencyPair), side, type, amount, price));
  }

  public TheRockOrder placeTheRockOrder(CurrencyPair currencyPair, TheRockOrder order)
      throws ExchangeException, IOException {
    try {
  ...
  public TheRockOrder cancelTheRockOrder(CurrencyPair currencyPair, Long orderId)
      throws TheRockException, IOException {
    try {
      return theRockAuthenticated.cancelOrder(
          new TheRock.Pair(currencyPair),
          orderId,
          exchange.getExchangeSpecification().getApiKey(),
          signatureCreator,
  ...
  public TheRockOrders getTheRockOrders(CurrencyPair currencyPair)
      throws TheRockException, IOException {
    try {
  ...
  public TheRockOrders getTheRockOrders(
      CurrencyPair currencyPair,
      Date after,
      Date before,
      String status,
