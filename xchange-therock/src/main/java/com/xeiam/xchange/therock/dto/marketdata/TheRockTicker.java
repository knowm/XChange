package com.xeiam.xchange.therock.dto.marketdata;
...
public class TheRockTicker {
    ...
    public String toString() {
        return String.format("TheRockTicker{currencyPair=%s, date=%s, bid=%s, ask=%s, last=%s, volume=%s, volumeTraed=%s, open=%s, high=%s, low=%s, close=%s}",
