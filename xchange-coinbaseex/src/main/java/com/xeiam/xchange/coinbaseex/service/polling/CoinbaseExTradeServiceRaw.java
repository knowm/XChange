...
public class CoinbaseExTradeServiceRaw extends CoinbaseExBasePollingService<CoinbaseEx> {
  ...
  public CoinbaseExIdResponse placeCoinbaseExLimitOrder(LimitOrder limitOrder) {
	  ...
	  return coinbaseEx.placeLimitOrder(new CoinbaseExPlaceOrder(limitOrder.getTradableAmount(), limitOrder.getLimitPrice(), side, productId), apiKey, digest, getTimestamp(), passphrase);
  }
  
  public void cancelCoinbaseExOrder(String id) {
