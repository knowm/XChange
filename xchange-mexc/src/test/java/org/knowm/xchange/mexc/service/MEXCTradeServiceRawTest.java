...
public class MEXCTradeServiceRawTest extends BaseWiremockTest {
  ...
  public void testGetMEXCTradeServiceRawOrder() throws IOException {
    ...
    MEXCResult<List<MEXCOrder>> order =
        mexcAccountServiceRaw.getOrders(Arrays.asList("1234567891011121314"));
    ...
    assertThat(responseObjectResult.get(0).get("symbol").textValue())
        .isEqualTo(orderResult.getSymbol());
    assertThat(responseObjectResult.get(0).get("price").textValue())
        .isEqualTo(orderResult.getPrice());
    assertThat(responseObjectResult.get(0).get("quantity").textValue())
        .isEqualTo(orderResult.getQuantity());
    assertThat(responseObjectResult.get(0).get("state").textValue())
        .isEqualTo(orderResult.getState());
    assertThat(responseObjectResult.get(0).get("type").textValue())
        .isEqualTo(orderResult.getType());
    assertThat(responseObjectResult.get(0).get("deal_quantity").textValue())
        .isEqualTo(orderResult.getDealQuantity());
    assertThat(responseObjectResult.get(0).get("deal_amount").textValue())
        .isEqualTo(orderResult.getDealAmount());
    assertThat(responseObjectResult.get(0).get("create_time").longValue())
        .isEqualTo(orderResult.getCreateTime());

    orderResult = orderResults.get(1);

    assertThat(responseObjectResult.get(1).get("id").textValue()).isEqualTo(orderResult.getId());
    assertThat(responseObjectResult.get(1).get("symbol").textValue())
        .isEqualTo(orderResult.getSymbol());
    assertThat(responseObjectResult.get(1).get("price").textValue())
        .isEqualTo(orderResult.getPrice());
    assertThat(responseObjectResult.get(1).get("quantity").textValue())
        .isEqualTo(orderResult.getQuantity());
    assertThat(responseObjectResult.get(1).get("state").textValue())
        .isEqualTo(orderResult.getState());
    assertThat(responseObjectResult.get(1).get("type").textValue())
        .isEqualTo(orderResult.getType());
    assertThat(responseObjectResult.get(1).get("deal_quantity").textValue())
        .isEqualTo(orderResult.getDealQuantity());
    assertThat(responseObjectResult.get(1).get("deal_amount").textValue())
        .isEqualTo(orderResult.getDealAmount());
    assertThat(responseObjectResult.get(1).get("create_time").longValue())
        .isEqualTo(orderResult.getCreateTime());
  }
  ...
  public void testPlaceMEXCTradeServiceRawOrder() throws IOException {
    ...
    MEXCResult<String> orderPlacementResult =
        mexcTradeServiceRaw.placeOrder(
            new MEXCOrderRequestPayload("COINUSDT", "1.0", "1.0", "BID", "LIMIT_ORDER", null));
