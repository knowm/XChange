...
public interface CexIO {
   ...
   *
   * <p>At the moment CexIO has the following 5 markets: USD, EUR, GBP, RUB, BTC</p>
   * <p>We are hardcoding those 5 markets in the path since ResCU rest client does not support passing an arbitrary number of
   * optional path params.</p>
   * <p>If RecCU supported that then we would like to get rid of this method and create a method with the following signature
   * {@code getTickers(Set<String>)} where each string in the set will be added as a path parameter</p>
   * <p>See <a href="https://github.com/mmazi/rescu/issues/110" target="_top">https://github.com/mmazi/rescu/issues/110</a></p>
   *
