...
public interface LunoAPI {
   ...
   *
   * @param pair required - Currency pair e.g. XBTZAR
   * @param since optional - Fetch trades executed after this time, specified as a Unix timestamp in
   *     milliseconds.
   * @return
   * @throws IOException
   * @throws LunoException
   ...
   * @throws LunoException
   */
  LunoAccountTransactions transactions(String id, int minRow, int maxRow)
   ...
   * @throws LunoException
   */
  LunoUserTrades listTrades(String pair, Long since, Integer limit)
      throws IOException, LunoException;
   ...
   * @throws LunoException
   */
  LunoFundingAddress getFundingAddress(String asset, String address)
      throws IOException, LunoException;
