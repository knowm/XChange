...
public class TestMatchingEngine {
  ...
  public void testAskNoMatch() {
    ...
    // When
    LimitOrder result = matchingEngine.postOrder(TAKER, new LimitOrder.Builder(ASK, BTC_USD)
  ...
  public void testBidNoMatch() {
    ...
    // When
    LimitOrder result = matchingEngine.postOrder(TAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(5))
        .build());
  ...
  public void testMarketAskEmptyBook() {
    matchingEngine.postOrder(TAKER, new MarketOrder.Builder(ASK, BTC_USD)
        .originalAmount(new BigDecimal(5))
        .build());
  }
  ...
  public void testMarketBidEmptyBook() {
    matchingEngine.postOrder(TAKER, new MarketOrder.Builder(BID, BTC_USD)
        .originalAmount(new BigDecimal(5))
        .build());
  }
  ...
  public void testSimpleAskMatch() {
    ...
    // Given
    LimitOrder maker = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(5))
        .build());
  ...
  public void testSimpleBidMatch() {
    ...
    // Given
    LimitOrder maker = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(5))
        .build());
  ...
  public void testAskMultiple() {
    ...
    LimitOrder maker1 =matchingEngine.postOrder(MAKER, new LimitOrder.Builder(BID, BTC_USD)
        ...
        .build());
    LimitOrder maker2 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(2))
        .build());
    LimitOrder maker3 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(4))
        .build());
    LimitOrder maker4 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(101))
        .originalAmount(new BigDecimal(8))
        .build());

    // When
    LimitOrder taker1 = matchingEngine.postOrder(TAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(100))
    ...
    assertThat(fillCaptor1.getAllValues(), contains(
    ...
    // When
    LimitOrder taker2 = matchingEngine.postOrder(TAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(5))
        .build());
    ...
    assertThat(fillCaptor2.getAllValues(), contains(
  ...
  public void testBidMultiple() {
    ...
    // Given
    LimitOrder maker1 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(100))
        .originalAmount(new BigDecimal(1))
        .build());
    LimitOrder maker2 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(102))
        .originalAmount(new BigDecimal(2))
        .build());
    LimitOrder maker3 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(102))
        .originalAmount(new BigDecimal(4))
        .build());
    LimitOrder maker4 = matchingEngine.postOrder(MAKER, new LimitOrder.Builder(ASK, BTC_USD)
        .limitPrice(new BigDecimal(101))
        .originalAmount(new BigDecimal(8))
        .build());

    // When
    LimitOrder taker1 = matchingEngine.postOrder(TAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(102))
        .originalAmount(new BigDecimal(10))
        .build());
    ...
    // When
    LimitOrder taker2 = matchingEngine.postOrder(TAKER, new LimitOrder.Builder(BID, BTC_USD)
        .limitPrice(new BigDecimal(102))
        .originalAmount(new BigDecimal(5))
        .build());
  ...
  private FillMatcher useAmount(String apiKey, LimitOrder order, BigDecimal amount, BigDecimal price) {
    return fillMatcher()
