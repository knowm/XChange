...
class FillAssert extends AbstractFillAssert<FillAssert, Fill> {
  ...
  /**
   * An entry point for FillAssert to follow AssertJ standard <code>assertThat()</code> statements.<br>
   * With a static import, one can write directly: <code>assertThat(myFill)</code> and get specific assertion with code completion.
   * @param actual the Fill we want to make assertions on.
