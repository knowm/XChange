...
/**
 * Abstract base class for {@link UserTrade} specific assertions - Generated by CustomAssertionGenerator.
 */
@javax.annotation.Generated(value="assertj-assertions-generator")
abstract class AbstractUserTradeAssert<S extends AbstractUserTradeAssert<S, A>, A extends UserTrade> extends AbstractTradeAssert<S, A> {

  /**
   * Creates a new <code>{@link AbstractUserTradeAssert}</code> to make assertions on actual UserTrade.
