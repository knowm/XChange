...
class UserTradeAssert extends AbstractUserTradeAssert<UserTradeAssert, UserTrade> {
  ...
  /**
   * An entry point for UserTradeAssert to follow AssertJ standard <code>assertThat()</code> statements.<br>
   * With a static import, one can write directly: <code>assertThat(myUserTrade)</code> and get specific assertion with code completion.
   * @param actual the UserTrade we want to make assertions on.
