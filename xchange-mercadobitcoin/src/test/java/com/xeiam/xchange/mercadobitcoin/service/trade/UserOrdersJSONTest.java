...
public class UserOrdersJSONTest {
  ...
  public void testUnmarshal() throws IOException {
    ...
    MercadoBitcoinBaseTradeApiResult<MercadoBitcoinCancelOrderResult> apiResult = mapper.readValue(is, new TypeReference<MercadoBitcoinBaseTradeApiResult<MercadoBitcoinUserOrders>>() {
    });
