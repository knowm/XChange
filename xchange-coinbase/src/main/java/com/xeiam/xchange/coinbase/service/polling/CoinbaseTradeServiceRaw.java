...
class CoinbaseTradeServiceRaw extends CoinbaseBasePollingService {
  ...
  /**
   * Authenticated resource that lets you purchase Bitcoin using the primary
   * bank account that is linked to your account. (You must link and verify your
   * bank account through the website before this API call will work). The
   * underlying optional parameter agree_btc_amount_varies is set to false. Use
   * {@link #buyAndAgreeBTCAmountVaries} to have it set to true.
   *
   * @see <a
   ...
   * bank account that is linked to your account. (You must link and verify your
   * bank account through the website before this API call will work). The
   * underlying optional parameter agree_btc_amount_varies is set to true. Use
   * {@link #buyAndAgreeBTCAmountVaries} to have it set to false.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/buys/create.html">coinbase.com/api/doc/1.0/buys/create.html</a>
   * @param quantity The quantity of Bitcoin you would like to buy.
  ...
  /**
   * Authenticated resource that lets you convert Bitcoin in your account to USD
   * by crediting your primary bank account on Coinbase. (You must link and
   * verify your bank account through the website before this API call will
   * work).
   *
   * @see <a
   ...
   * sells. Sorted in descending order by creation date. This is a paged
