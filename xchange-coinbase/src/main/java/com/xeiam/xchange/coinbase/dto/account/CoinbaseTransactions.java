...
public class CoinbaseTransactions extends CoinbasePagedResult {
  ...
  private CoinbaseTransactions(@JsonProperty("current_user") final CoinbaseUserInfo currentUser,
      @JsonProperty("balance") final CoinbaseMoney balance, @JsonProperty("transactions") final List<CoinbaseTransaction> transactions,
