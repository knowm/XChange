...
class CoinbaseAccountServiceRaw extends CoinbaseBasePollingService<CoinbaseAuthenticated> {
   ...
   * @param exchange
   */
  public CoinbaseAccountServiceRaw(final Exchange exchange) {
   ...
   * @return A {@code CoinbaseUsers} wrapper around the current
   *         {@code CoinbaseUser} containing account settings.
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource that lets you update account settings for the
   * current user. Use {@link #getCoinbaseUsers()} to retrieve the current user
   * first.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/users/update.html">coinbase.com/api/doc/1.0/users/update.html</a>
   * @param user {@code CoinbaseUser} with new information to be updated.
   * @return The current {@code CoinbaseUser} with the requested updated account
   *         settings.
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource which claims a redeemable token for its address and
   * Bitcoin.
   *
   * @see <a
  ...
  /**
   * Authenticated resource that returns the user’s current account balance in
   * BTC.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/accounts/balance.html">coinbase.com/api/doc/1.0/accounts/balance.html</a>
   * @return A {@code CoinbaseAmount} wrapper around a {@code CoinbaseMoney}
   *         object representing the current user's balance.
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource that returns the user’s current Bitcoin receive
   * address.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/accounts/receive_address.html">coinbase.com/api/doc/1.0/accounts/receive_address.html</a>
  ...
  /**
   * Authenticated resource that returns Bitcoin addresses a user has associated
   * with their account. This is a paged resource and will return the first page
   * by default.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/addresses/index.html">coinbase.com/api/doc/1.0/addresses/index.html</a>
   * @return A {@code CoinbaseAddresses} wrapper around a collection of
   *         {@code CoinbaseAddress's} associated with the current user's
   *         account.
   * @throws IOException
   */
   ...
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/addresses/index.html">coinbase.com/api/doc/1.0/addresses/index.html</a>
   * @param page Optional parameter to request a desired page of results. Will
   *          return page 1 if the supplied page is null or less than 1.
   * @param limit Optional parameter to limit the maximum number of results to
   *          return. Will return up to 25 results by default if null or less
   *          than 1.
   * @param filter Optional String match to filter addresses. Matches the
   *          address itself and also if the use has set a ‘label’ on the
   *          address. No filter is applied if {@code filter} is null or empty.
   * @return A {@code CoinbaseAddresses} wrapper around a collection of
   *         {@code CoinbaseAddress's} associated with the current user's
   *         account.
   * @throws IOException
  ...
  /**
   * Authenticated resource that generates a new Bitcoin receive address for the
   * user.
   *
   * @see <a
   ...
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/accounts/generate_receive_address.html">coinbase.com/api/doc/1.0/accounts/generate_receive_address.html</a>
   * @param callbackUrl Optional Callback URL to receive instant payment
   *          notifications whenever funds arrive to this address.
   * @param label Optional text label for the address which can be used to
   *          filter against when calling {@link #getCoinbaseAddresses}.
   * @return The user’s newly generated and current {@code CoinbaseAddress}.
   * @throws IOException
   */
   ...
   * This is an alternative to the {@code getCoinbaseTransactions} API call. It
   * is designed to be faster and provide more detail so you can generate an
   * overview/summary of individual account changes. This is a paged resource
   * and will return 30 results representing the first page by default.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/account_changes/index.html">coinbase.com/api/doc/1.0/account_changes/index.html</a>
   ...
   * This is an alternative to the {@code getCoinbaseTransactions} API call. It
   * is designed to be faster and provide more detail so you can generate an
   * overview/summary of individual account changes.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/account_changes/index.html">coinbase.com/api/doc/1.0/account_changes/index.html</a>
   * @param page Optional parameter to request a desired page of results. Will
  ...
  /**
   * Authenticated resource that returns contacts the user has previously sent
   * to or received from. This is a paged resource and will return the first
   * page by default.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/contacts/index.html">coinbase.com/api/doc/1.0/contacts/index.html</a>
   * @return {@code CoinbaseContacts} the user has previously sent to or
   *         received from.
   * @throws IOException
   */
   ...
   * Sorted in descending order by creation date. This is a paged resource and
   * will return the first page by default.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/transactions/index.html">coinbase.com/api/doc/1.0/transactions/index.html</a>
  ...
  /**
   * Authenticated resource which returns the details of an individual
   * transaction.
   *
   * @see <a
  ...
  /**
   * Authenticated resource which lets you send money to an email or Bitcoin
   * address.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/transactions/send_money.html">coinbase.com/api/doc/1.0/transactions/send_money.html</a>
   * @param transactionRequest
   * @return A completed {@code CoinbaseTransaction} representing the desired
   *         {@code CoinbaseSendMoneyRequest}.
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource which lets a user complete a money request. Money
   * requests can only be completed by the sender (not the recipient). Remember
   * that the sender in this context is the user who is sending money (not
   ...
   * @param transactionId
   * @return The {@code CoinbaseTransaction} representing the completed
   *         {@code CoinbaseSendMoneyRequest}.
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource which lets a user cancel a money request. Money
   * requests can be canceled by the sender or the recipient.
   *
   * @see <a
  ...
  /**
   * Authenticated resource that creates a payment button, page, or iFrame to
   * accept Bitcoin on your website. This can be used to accept Bitcoin for an
   * individual item or to integrate with your existing shopping cart solution.
   * For example, you could create a new payment button for each shopping cart
   * on your website, setting the total and order number in the button at
   * checkout.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/buttons/create.html">coinbase.com/api/doc/1.0/buttons/create.html</a>
   * @param button A {@code CoinbaseButton} containing the desired button
   *          configuration for Coinbase to create.
  ...
  /**
   * Authenticated resource which returns a merchant’s orders that they have
   * received. Sorted in descending order by creation date. This is a paged
   * resource and will return the first page by default, use
   * {@link #getCoinbaseOrders(Integer page)} to retrieve additional pages.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/orders/index.html">coinbase.com/api/doc/1.0/orders/index.html</a>
   * @return
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource which returns a merchant’s orders that they have
   * received. Sorted in descending order by creation date.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/orders/index.html">coinbase.com/api/doc/1.0/orders/index.html</a>
   * @param page Optional parameter to request a desired page of results. Will
  ...
  /**
   * Authenticated resource which returns order details for a specific order id
   * or merchant custom.
   *
   * @see <a
  ...
  /**
   * Authenticated resource which lets you generate an order associated with a
   * button. After generating an order, you can send Bitcoin to the address
   * associated with the order to complete the order. The status of this newly
   * created order will be ‘new’.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/buttons/create_order.html">coinbase.com/api/doc/1.0/buttons/create_order.html</a>
   ...
   * @param button A {@code CoinbaseButton} containing information to create a
   *          one time order.
   * @return The newly created {@code CoinbaseOrder}.
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource that lets you list all your recurring payments
   * (scheduled buys, sells, and subscriptions you’ve created with merchants).
  ...
  /**
   * Authenticated resource that lets you (as a merchant) list all the
   * subscriptions customers have made with you. This call returns
   * {@code CoinbaseSubscription} objects where you are the merchant. This is a
   * paged resource and will return the first page by default.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/subscribers/index.html">coinbase.com/api/doc/1.0/subscribers/index.html</a>
   * @return
   * @throws IOException
   */
  ...
  /**
   * Authenticated resource that lets you (as a merchant) show an individual
   * subscription than a customer has created with you. This call returns a
   * {@code CoinbaseSubscription} object where you are the merchant.
   *
   * @see <a
   *      href="https://coinbase.com/api/doc/1.0/subscribers/show.html">coinbase.com/api/doc/1.0/subscribers/show.html</a>
