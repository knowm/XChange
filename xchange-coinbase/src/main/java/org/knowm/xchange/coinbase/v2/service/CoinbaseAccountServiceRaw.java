...
class CoinbaseAccountServiceRaw extends CoinbaseBaseService {
    ...
    public Map getTransactions(String accountId) throws IOException {
        ...
        return coinbase.getTransactions(Coinbase.CB_VERSION_VALUE, apiKey, signatureCreator2, timestamp, accountId);
    }
    ...
    public List<CoinbaseAccount> getCoinbaseAccounts() throws IOException {
        ...
        return coinbase.getAccounts(Coinbase.CB_VERSION_VALUE, apiKey, signatureCreator2, timestamp).getData();
    }
    ...
    public CoinbaseAccount getCoinbaseAccount(Currency currency) throws IOException {
        ...
        return coinbase.getAccount(Coinbase.CB_VERSION_VALUE, apiKey, signatureCreator2, timestamp, currency.getCurrencyCode()).getData();
    }
