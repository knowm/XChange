...
public class MeXBTOrderModifyRequest extends MeXBTInsRequest {
  ...
  public MeXBTOrderModifyRequest(String apiKey, SynchronizedValueFactory<Long> nonceFactory, MeXBTDigest meXBTDigest, String ins, String serverOrderId, int modifyAction) {
