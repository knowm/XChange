...
import com.xeiam.xchange.mexbt.dto.account.MeXBTBalanceResponseTest;
import com.xeiam.xchange.mexbt.dto.account.MeXBTOpenOrdersResponse;
import com.xeiam.xchange.mexbt.dto.account.MeXBTOpenOrdersResponseTest;
import com.xeiam.xchange.mexbt.dto.account.MeXBTTradeResponse;
import com.xeiam.xchange.mexbt.dto.account.MeXBTUserTradeResponseTest;
import com.xeiam.xchange.mexbt.dto.marketdata.MeXBTOrderBook;
import com.xeiam.xchange.mexbt.dto.marketdata.MeXBTOrderBookTest;
import com.xeiam.xchange.mexbt.dto.marketdata.MeXBTTicker;
import com.xeiam.xchange.mexbt.dto.marketdata.MeXBTTickerTest;
import com.xeiam.xchange.mexbt.dto.marketdata.MeXBTTrade;
import com.xeiam.xchange.mexbt.dto.marketdata.MeXBTTradeTest;
...
public class MeXBTAdaptersTest {
  ...
  public void testAdaptAccountInfo() throws JsonParseException, JsonMappingException, IOException {
    ...
    assertEquals(new BigDecimal("482198.87"), accountInfo.getWallet(Currency.BTC).getAvailable());
    assertEquals(new BigDecimal("482056"), accountInfo.getWallet(Currency.BTC).getFrozen());
    assertEquals(new BigDecimal("990119"), accountInfo.getWallet(Currency.LTC).getAvailable());
    assertEquals(new BigDecimal("11108"), accountInfo.getWallet(Currency.LTC).getFrozen());
  }
