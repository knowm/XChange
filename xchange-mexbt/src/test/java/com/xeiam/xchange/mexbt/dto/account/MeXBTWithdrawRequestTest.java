...
public class MeXBTWithdrawRequestTest {
  ...
  public void testMeXBTWithdrawRequest() throws JsonProcessingException {
    MeXBTWithdrawRequest request = new MeXBTWithdrawRequest("myApiKey", new CurrentTimeNonceFactory(), MeXBTDigest.createInstance("f223148561ecda30b98083cf02be96a7", "hello",
        "5a1f5a691c281b3754d8826510065ab8"), "BTC", new BigDecimal("0.00000001"), "testAddress");
