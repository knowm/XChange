...
public class VircurexMarketDataServiceRaw extends VircurexBaseService {
  ...
  public VircurexLastTrade getVircurexTicker(CurrencyPair currencyPair) throws IOException {
    ...
    VircurexLastTrade vircurexLastTrade = vircurexAuthenticated
        .getLastTrade(currencyPair.base.getCurrencyCode().toLowerCase(), currencyPair.counter.getCurrencyCode().toLowerCase());
  ...
  public VircurexDepth getVircurexOrderBook(CurrencyPair currencyPair) throws IOException {
    ...
    VircurexDepth vircurexDepth = vircurexAuthenticated
        .getFullDepth(currencyPair.base.getCurrencyCode().toLowerCase(), currencyPair.counter.getCurrencyCode().toLowerCase());
