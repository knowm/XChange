...
class BitfinexAccountServiceTest extends BitfinexExchangeWiremock {
  ...
  void funding_history_movements() throws IOException {
    ...
    var expected = FundingRecord.builder()
        ...
        .internalId("23725209")
        .blockchainTransactionHash("0x0dbc079033fa5422b2aac4e58fb55ac27610b41134b4c6e0bc45fb5b57e5f1a8")
  ...
  void funding_internal_sub_account_transfers() throws IOException {
    var actual = accountService.getFundingHistory(BitfinexFundingHistoryParams.builder().type(Type.INTERNAL_SUB_ACCOUNT_TRANSFER).build());
    ...
    var expected = FundingRecord.builder()
        ...
        .description("Transfer of 5.0 UST from wallet Exchange to Exchange SA(acc1->acc2) on wallet exchange")
        .build();
  ...
  void funding_internal_wallet_transfers() throws IOException {
    var actual = accountService.getFundingHistory(BitfinexFundingHistoryParams.builder().type(Type.INTERNAL_WALLET_TRANSFER).build());
