...
public class BitfinexWebSocketAuth {
    ...
    public BitfinexWebSocketAuth(@JsonProperty("apiKey") String apiKey, @JsonProperty("authPayload") String authPayload,
                                 @JsonProperty("authNonce") String authNonce, @JsonProperty("authSig") String authSig) {
        this.apiKey = apiKey;
        this.event = "auth";
