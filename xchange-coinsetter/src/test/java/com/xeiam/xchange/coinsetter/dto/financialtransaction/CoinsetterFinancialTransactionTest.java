...
public class CoinsetterFinancialTransactionTest {
  ...
  public void test() throws IOException {
    ...
    CoinsetterFinancialTransaction financialTransaction = mapper.readValue(getClass().getResource("financialTransaction.json"), CoinsetterFinancialTransaction.class);
