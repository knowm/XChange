...
public class LykkeAssetsTest {
    ...
    public void testUnmarschalLykkeAssets() throws IOException {
        ...
        assertThat(assetPairs[0].getName()).isEqualTo("Erc20 token Friendz Coin (0x23352036e911a22cfc692b5e2e196692658aded9)");
        assertThat(assetPairs[0].getDisplayId()).isEqualTo("FDZ");
        assertThat(assetPairs[0].getBitcoinAssetId()).isEqualTo("0x23352036e911a22cfc692b5e2e196692658aded9");
