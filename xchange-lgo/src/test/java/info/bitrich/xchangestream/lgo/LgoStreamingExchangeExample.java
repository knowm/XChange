...
public class LgoStreamingExchangeExample {
    ...
    public void placeLimitOrder() throws IOException {
        String ref = exchange
                .getStreamingTradeService()
                .placeLimitOrder(new LimitOrder(Order.OrderType.ASK, new BigDecimal("0.5"), CurrencyPair.BTC_USD, null, new Date(), new BigDecimal("12000")));
    ...
    public void placeMarketOrder() throws IOException {
        String ref = exchange
                .getStreamingTradeService()
                .placeMarketOrder(new MarketOrder(Order.OrderType.ASK, new BigDecimal("0.5"), CurrencyPair.BTC_USD, null, new Date()));
        System.out.println("Order was placed with reference: " + ref);
    }
