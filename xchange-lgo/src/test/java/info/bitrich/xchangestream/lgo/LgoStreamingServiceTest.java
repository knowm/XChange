...
public class LgoStreamingServiceTest {
    ...
    public void it_returns_the_trades_subscribe_message() throws IOException {
        ...
        assertThat(asJsonNode(subscribeMessage)).isEqualTo(getJsonContent("/subscribe/trades-subscribe.json"));
    }
    ...
    public void it_returns_the_level2_subscribe_message() throws IOException {
        ...
        assertThat(asJsonNode(subscribeMessage)).isEqualTo(getJsonContent("/subscribe/level2-subscribe.json"));
    }
    ...
    public void it_returns_the_balance_subscribe_message() throws IOException {
        ...
        assertThat(asJsonNode(subscribeMessage)).isEqualTo(getJsonContent("/subscribe/balance-subscribe.json"));
    }
