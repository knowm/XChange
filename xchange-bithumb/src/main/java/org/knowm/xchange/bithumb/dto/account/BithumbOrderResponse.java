...
public class BithumbOrderResponse extends BithumbResponse<List<BithumbOrderResponse.BithumbOrder>> {

  public BithumbOrderResponse(
      @JsonProperty("status") String status,
      @JsonProperty("message") String message,
      @JsonProperty("data") List<BithumbOrder> data) {
    super(status, message, data);
  }

  public static class BithumbOrder {
