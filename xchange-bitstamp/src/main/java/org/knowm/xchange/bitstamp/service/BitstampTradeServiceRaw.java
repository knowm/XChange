...
public class BitstampTradeServiceRaw extends BitstampBaseService {
    ...
    public BitstampTradeServiceRaw(Exchange exchange) {
        ...
        this.signatureCreatorV2 =
                BitstampDigestV2.createInstance(exchange.getExchangeSpecification().getSecretKey(), exchange.getExchangeSpecification().getApiKey());
    ...
    public boolean cancelAllBitstampOrders() throws IOException {
        ...
        try {
            BitstampCancelAllOrdersResponse response =  bitstampAuthenticatedV2.cancelAllOrders(apiKeyForV2Requests,
                    signatureCreatorV2,
                    uuidNonceFactory,
                    timestampFactory,
                    API_VERSION);
