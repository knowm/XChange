...
public class DepositAddressJSONTest {
  ...
  public void testError() throws IOException {
    BitstampDepositAddress address = unmarshall("/org/knowm/xchange/bitstamp/dto/account/example-deposit-error.json");
  ...
  public void testV1DepositResponse() throws IOException {
    final BitstampDepositAddress address = unmarshall("/org/knowm/xchange/bitstamp/dto/account/example-deposit-response.json");
  ...
  public void testV2DepositResponse() throws IOException {
    final BitstampDepositAddress address = unmarshall("/org/knowm/xchange/bitstamp/dto/account/example-v2-deposit-response.json");
    assertThat(address.getError()).isNullOrEmpty();
    assertThat(address.getDepositAddress()).isNotBlank();
  }
}
