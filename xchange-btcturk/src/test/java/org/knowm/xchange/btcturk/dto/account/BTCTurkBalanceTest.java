...
public class BTCTurkBalanceTest {
	...
	@Test
	  public void testUnmarshal() throws IOException {
		...
		assertThat(btcTurkTicker.getBtctry_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0021186440000000"));
		assertThat(btcTurkTicker.getBtctry_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
		assertThat(btcTurkTicker.getEthtry_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
		assertThat(btcTurkTicker.getEthtry_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0"));
		assertThat(btcTurkTicker.getEthbtc_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0021186440000000"));
		assertThat(btcTurkTicker.getEthbtc_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
		assertThat(btcTurkTicker.getXrptry_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0021186440000000"));
		assertThat(btcTurkTicker.getXrptry_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
		assertThat(btcTurkTicker.getLtctry_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0021186440000000"));
		assertThat(btcTurkTicker.getLtctry_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
		assertThat(btcTurkTicker.getUsdttry_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0021186440000000"));
		assertThat(btcTurkTicker.getUsdttry_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
		assertThat(btcTurkTicker.getXlmtry_taker_fee_percentage()).isEqualTo(new BigDecimal("0.0021186440000000"));
		assertThat(btcTurkTicker.getXlmtry_maker_fee_percentage()).isEqualTo(new BigDecimal("0.0012711860000000"));
	  }
}
