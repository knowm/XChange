...
public class BTCTurkDepositRequestResult {
	...
	public String toString() {
		return "BTCTurkDepositRequestResult [id=" + id + ", depositCode=" + depositCode + ", banks=" + banks
				+ ", currencyType=" + currencyType + ", amount=" + amount + ", firstName=" + firstName + ", lastName="
				+ lastName + ", accountOwner=" + accountOwner + "]";
	}
