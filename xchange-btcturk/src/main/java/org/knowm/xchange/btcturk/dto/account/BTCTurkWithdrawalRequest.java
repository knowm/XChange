...
public class BTCTurkWithdrawalRequest {
	...
	public String toString() {
		return "BTCTurkWithdrawalRequest [iban=" + iban + ", friendlyName=" + friendlyName + ", friendlyNameSave="
				+ friendlyNameSave + ", amount=" + amount + ", amountPrecision=" + amountPrecision
				+ ", hasBalanceRequest=" + hasBalanceRequest + ", balanceRequestId=" + balanceRequestId + ", bankId="
				+ bankId + ", bankName=" + bankName + ", firstName=" + firstName + ", lastName=" + lastName + "]";
	}
