...
public String toString() {
	return "BTCTurkAccountBalance [try_balance=" + try_balance + ", btc_balance=" + btc_balance + ", eth_balance="
			+ eth_balance + ", xrp_balance=" + xrp_balance + ", ltc_balance=" + ltc_balance + ", usdt_balance="
			+ usdt_balance + ", xlm_balance=" + xlm_balance + ", try_reserved=" + try_reserved + ", btc_reserved="
			+ btc_reserved + ", eth_reserved=" + eth_reserved + ", xrp_reserved=" + xrp_reserved + ", ltc_reserved="
			+ ltc_reserved + ", usdt_reserved=" + usdt_reserved + ", xlm_reserved=" + xlm_reserved + ", try_available="
			+ try_available + ", btc_available=" + btc_available + ", eth_available=" + eth_available
			+ ", xrp_available=" + xrp_available + ", ltc_available=" + ltc_available + ", usdt_available="
			+ usdt_available + ", xlm_available=" + xlm_available + ", btctry_taker_fee_percentage="
			+ btctry_taker_fee_percentage + ", btctry_maker_fee_percentage=" + btctry_maker_fee_percentage
			+ ", ethtry_taker_fee_percentage=" + ethtry_taker_fee_percentage + ", ethtry_maker_fee_percentage="
			+ ethtry_maker_fee_percentage + ", ethbtc_taker_fee_percentage=" + ethbtc_taker_fee_percentage
			+ ", ethbtc_maker_fee_percentage=" + ethbtc_maker_fee_percentage + ", xrptry_taker_fee_percentage="
			+ xrptry_taker_fee_percentage + ", xrptry_maker_fee_percentage=" + xrptry_maker_fee_percentage
			+ ", ltctry_taker_fee_percentage=" + ltctry_taker_fee_percentage + ", ltctry_maker_fee_percentage="
			+ ltctry_maker_fee_percentage + ", usdttry_taker_fee_percentage=" + usdttry_taker_fee_percentage
			+ ", usdttry_maker_fee_percentage=" + usdttry_maker_fee_percentage + ", xlmtry_taker_fee_percentage="
			+ xlmtry_taker_fee_percentage + ", xlmtry_maker_fee_percentage=" + xlmtry_maker_fee_percentage + "]";
}
}
