...
public class BTCTurkWithdrawalRequestInfo {
	...
	public String toString() {
		return "BTCTurkWithdrawalRequestInfo [iban=" + iban + ", bankList=" + bankList + ", friendlyNameList="
				+ friendlyNameList + ", bankName=" + bankName + ", amount=" + amount + ", hasBalanceRequest="
				+ hasBalanceRequest + ", balanceRequestId=" + balanceRequestId + ", firstName=" + firstName
				+ ", lastName=" + lastName + "]";
	}
