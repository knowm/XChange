...
public interface Exmo {
    ...
    Map userInfo(@HeaderParam("Sign") ExmoDigest signatureCreator, @HeaderParam("Key") String publicKey, @FormParam("nonce") SynchronizedValueFactory<Long> nonceFactory);

    @POST
    @Path("/order_create/")
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    Map orderCreate(@HeaderParam("Sign") ExmoDigest signatureCreator, @HeaderParam("Key") String publicKey, @FormParam("nonce") SynchronizedValueFactory<Long> nonceFactory,
                    @FormParam("pair") String pair, @FormParam("quantity") BigDecimal quantity, @FormParam("price") BigDecimal price, @FormParam("type") String type);

    @POST
    @Path("/order_cancel/")
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    Map orderCancel(@HeaderParam("Sign") ExmoDigest signatureCreator, @HeaderParam("Key") String publicKey, @FormParam("nonce") SynchronizedValueFactory<Long> nonceFactory,
                    @FormParam("order_id") String orderId);

    @POST
    @Path("/user_open_orders/")
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    Map<String, List<Map<String, String>>> userOpenOrders(@HeaderParam("Sign") ExmoDigest signatureCreator, @HeaderParam("Key") String publicKey, @FormParam("nonce") SynchronizedValueFactory<Long> nonceFactory);
    ...
    @Path("/order_trades/")
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    Map<String, Object> orderTrades(@HeaderParam("Sign") ExmoDigest signatureCreator, @HeaderParam("Key") String publicKey, @FormParam("nonce") SynchronizedValueFactory<Long> nonceFactory,
                                    @FormParam("order_id") String orderId);

    @POST
    @Path("/deposit_address/")
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    Map<String, String> depositAddress(@HeaderParam("Sign") ExmoDigest signatureCreator, @HeaderParam("Key") String publicKey, @FormParam("nonce") SynchronizedValueFactory<Long> nonceFactory);
