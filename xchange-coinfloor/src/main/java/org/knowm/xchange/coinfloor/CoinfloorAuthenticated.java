...
public interface CoinfloorAuthenticated {
  ...
  CoinfloorBalance getBalance(@PathParam("base") Currency base, @PathParam("counter") Currency counter) throws IOException;
  ...
  CoinfloorUserTransaction[] getUserTransactions(@PathParam("base") Currency base, @PathParam("counter") Currency counter,
      @FormParam("limit") Integer numberOfTransactions, @FormParam("offset") Long offset, @FormParam("sort") String sort) throws IOException;

  @GET
  @Path("{base}/{counter}/open_orders/")
  CoinfloorOrder[] getOpenOrders(@PathParam("base") Currency base, @PathParam("counter") Currency counter) throws IOException;
  ...
  CoinfloorMarketOrderResponse buyMarket(@PathParam("base") Currency base, @PathParam("counter") Currency counter,
      @FormParam("quantity") BigDecimal quantity) throws IOException;
  ...
  boolean cancelOrder(@PathParam("base") Currency base, @PathParam("counter") Currency counter, @FormParam("id") long id) throws IOException;
}
