...
public class CoinfloorEstimateMarketOrder{
	  ...
	  public CoinfloorEstimateMarketOrder(@JsonProperty("tag") int tag, @JsonProperty("errorCode") int errorCode,  
			  @JsonProperty("quantity") int baseQty, @JsonProperty("total") int counterQty){
		  this.tag = tag;
		  this.errorCode = errorCode;
		  this.baseQty = CoinfloorUtils.scaleToBigDecimal("BTC", baseQty);
		  this.counterQty = CoinfloorUtils.scaleToBigDecimal("GBP", counterQty);
	  }
