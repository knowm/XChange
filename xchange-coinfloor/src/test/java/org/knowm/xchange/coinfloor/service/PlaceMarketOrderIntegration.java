...
public class PlaceMarketOrderIntegration {
  ...
  public void placeLimitOrderTest() throws IOException {
    ...
    CoinfloorOrder order = rawService.placeLimitOrder(CurrencyPair.BTC_GBP, OrderType.ASK, new BigDecimal("0.00001"), new BigDecimal("1300.00"));
