...
public interface Hitbtc {
  ...
  public HitbtcTrades getTrades(@PathParam("currencyPair") String currencyPair, @QueryParam("from") Long from, @QueryParam("by") String sortBy, @QueryParam("sort") String sort,
      @QueryParam("start_index") Long startIndex, @QueryParam("max_results") Long max_results, @DefaultValue("object") @QueryParam("format_item") String format_item) throws IOException;
