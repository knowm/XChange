...
public class HitbtcSymbol {
   ...
   * @param lot lot
   */
  public HitbtcSymbol(@JsonProperty("symbol") String symbol, @JsonProperty("commodity") String commodity, @JsonProperty("currency") String currency, @JsonProperty("step") BigDecimal step,
