...
public class AscendexTradeDataJSONTest {
      ...
      public void ascendexPlaceOrderResponseTest() throws IOException {
            ...
            assertThat(ascendexAssets.getData().getInfo().getOrderId()).isEqualTo("16e85b4d9b9a8bXHbAwwoqDoc3d66830");
      }
      ...
      public void ascendexOpenOrdersResponseTest() throws IOException {
            ...
            AscendexResponse<List<AscendexOpenOrdersResponse>> ascendexAssets =
                    mapper.readValue(is, new TypeReference<AscendexResponse<List<AscendexOpenOrdersResponse>>>() {});
            ...
            assertThat(ascendexAssets.getData().get(0).getSymbol()).isEqualTo(CurrencyPairDeserializer.getCurrencyPairFromString("BTC/USDT").toString());
      }
      ...
      public void ascendexOrderHistoryResponseTest() throws IOException {
            ...
            // Verify that the example data was unmarshalled correctly
            assertThat(ascendexAssets.getData().size()).isEqualTo(1);
            assertThat(ascendexAssets.getData().get(0).getAvgPx()).isEqualByComparingTo(BigDecimal.valueOf(7243.34));
            assertThat(ascendexAssets.getData().get(0).getSymbol()).isEqualTo(CurrencyPairDeserializer.getCurrencyPairFromString("BTC/USDT").toString());
      }
}
