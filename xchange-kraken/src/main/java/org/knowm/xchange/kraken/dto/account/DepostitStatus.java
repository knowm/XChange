...
public class DepostitStatus {
    ...
    public DepostitStatus(@JsonProperty("method") String method, @JsonProperty("aclass") String aclass
    ...
    public String toString() {
      return "DepostitStatus [method=" + method + ", aclass=" + aclass + ", asset=" + asset + ", refid=" + refid + ", txid=" + txid
