...
public class KrakenTradeServiceRaw extends KrakenBaseService {
  ...
  public KrakenOrderResponse placeKrakenOrder(KrakenStandardOrder krakenStandardOrder) throws IOException {
    ...
    Map<String, String> closeOrder = krakenStandardOrder.getCloseOrder();
    if (!krakenStandardOrder.isValidateOnly()) {
      result = kraken.addOrder(KrakenUtils.createKrakenCurrencyPair(krakenStandardOrder.getAssetPair()), krakenStandardOrder.getType().toString(),
          ...
          krakenStandardOrder.getUserRefId(), closeOrder.get("ordertype"), closeOrder.get("price"), closeOrder.get("price2"),
      ...
      result = kraken
          .addOrderValidateOnly(KrakenUtils.createKrakenCurrencyPair(krakenStandardOrder.getAssetPair()), krakenStandardOrder.getType().toString(),
              ...
              krakenStandardOrder.getVolume().toPlainString(), krakenStandardOrder.getLeverage(), krakenStandardOrder.getPositionTxId(),
              delimitSet(krakenStandardOrder.getOrderFlags()), krakenStandardOrder.getStartTime(), krakenStandardOrder.getExpireTime(),
              krakenStandardOrder.getUserRefId(), true, closeOrder.get("ordertype"), closeOrder.get("price"),
              closeOrder.get("price2"), exchange.getExchangeSpecification().getApiKey(), signatureCreator, exchange.getNonceFactory());
    }
