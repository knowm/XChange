...
public class KrakenExchangeTest {
    ...
    public void minimunOrderSizeTest() throws IOException {
        ...
        Assert.assertEquals(1, currencyPairs.get(CurrencyPair.ADA_BTC).getMinimumAmount().doubleValue(), 0.01);
        Assert.assertEquals(1, currencyPairs.get(CurrencyPair.ADA_ETH).getMinimumAmount().doubleValue(), 0.01);
        Assert.assertEquals(1, currencyPairs.get(CurrencyPair.ADA_USD).getMinimumAmount().doubleValue(), 0.01);
        Assert.assertEquals(0.000002, currencyPairs.get(CurrencyPair.BCH_USD).getMinimumAmount().doubleValue(), 0.000001);
        Assert.assertEquals(1, currencyPairs.get(CurrencyPair.ATOM_ETH).getMinimumAmount().doubleValue(), 0.01);
