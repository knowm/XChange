...
public class BTCChinaTransaction {
	...
	public BTCChinaTransaction(
			@JsonProperty("id") long id, 
			@JsonProperty("type") String type, 
			@JsonProperty("btc_amount") BigDecimal btcAmount,
			@JsonProperty("ltc_amount") BigDecimal ltcAmount, 
			@JsonProperty("cny_amount") BigDecimal cnyAmount, 
