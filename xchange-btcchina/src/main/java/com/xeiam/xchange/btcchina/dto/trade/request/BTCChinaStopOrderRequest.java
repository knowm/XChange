...
public class BTCChinaStopOrderRequest extends BTCChinaRequest {
  ...
  public BTCChinaStopOrderRequest(String method, BigDecimal stopPrice, BigDecimal price, BigDecimal amount, BigDecimal trailingAmount, BigDecimal trailingPercentage, String market) {
    ...
    this.method = method;
    params = String.format("[%s,%s,%s,%s,%s,%s]", stopPrice == null ? "" : stopPrice.stripTrailingZeros().toPlainString(), price == null ? "null" : price.stripTrailingZeros().toPlainString(),
        amount.stripTrailingZeros().toPlainString(), trailingAmount == null ? "" : trailingAmount.stripTrailingZeros().toPlainString(),
