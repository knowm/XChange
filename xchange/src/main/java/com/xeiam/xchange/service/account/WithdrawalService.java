 ...
 * </ul>
 * <p>
 * All exchanges are unique in the way that they permit their customers to withdraw funds. To that end this API forces the implementation of a {@link WithdrawalRequestBuilder} that allows an individual exchange to construct the necessary values as
 * required.
 * </p>
 */
