 ...
 * </ul>
 * <p>A {@link MarketDataListener} is normally executed in a client thread using an executor service
 * and to facilitate this the {@link RunnableMarketDataListener} is provided as an extension point</p>
 *
 * @since 0.0.1
 *         
 */
