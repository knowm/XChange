...
//-------------------------
public class GetbtcTicker extends GetbtcTickerResponse {
         ...
         * @param monthRiseRate
         */
        public GetbtcTicker(BigDecimal vol, BigDecimal last, BigDecimal sell, BigDecimal buy, BigDecimal weekRiseRate, BigDecimal riseRate, BigDecimal high, BigDecimal low, BigDecimal monthRiseRate) {
            super();
            this.vol = vol;
            this.last = last;
            this.sell = sell;
