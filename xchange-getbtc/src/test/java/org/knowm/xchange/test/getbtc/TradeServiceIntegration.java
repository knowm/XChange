...
public class TradeServiceIntegration {
  ...
  private static void getOpenOrders() throws IOException {
    ...
    try {
	      GetbtcOpenOrdersParams exxOpenOrdersParams = (GetbtcOpenOrdersParams) tradeService.createOpenOrdersParams();
  ...
  private static void cancelOrder() throws IOException {        
    ...
    TradeService tradeService = exx.getTradeService();
    try {                 
      GetbtcCancelOrderByCurrencyPair exxCancelOrderByCurrencyPair = new GetbtcCancelOrderByCurrencyPair();
