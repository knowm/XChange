...
public final class CmcQuote {
	...
	public boolean equals(Object o) {
		...
		if (getVolume24h() != null ? !getVolume24h().equals(that.getVolume24h()) : that.getVolume24h() != null)
			return false;
		if (getPercentChange1h() != null ? !getPercentChange1h().equals(that.getPercentChange1h()) : that.getPercentChange1h() != null)
			return false;
		if (getPercentChange7d() != null ? !getPercentChange7d().equals(that.getPercentChange7d()) : that.getPercentChange7d() != null)
			return false;
		if (getPercentChange24h() != null ? !getPercentChange24h().equals(that.getPercentChange24h()) : that.getPercentChange24h() != null)
			return false;
