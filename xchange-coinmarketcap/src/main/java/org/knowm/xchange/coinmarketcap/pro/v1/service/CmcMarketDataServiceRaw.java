...
class CmcMarketDataServiceRaw extends CmcBaseService {
  ...
  public List<CmcTicker> getCmcLatestDataForAllCurrencies()
    ...
    try {
      response = cmcAuthenticated.getLatestListing(apiKey, 1, 5000,
  ...
  public List<CmcTicker> getCmcLatestDataForAllCurrencies(
          ...
          String sortByField, String sortDirection, String currencyType) throws IOException {

    CmcTickerListResponse response = null;
    try {
      response = cmcAuthenticated.getLatestListing(apiKey, startIndex, limitIndex, currencyCounters, sortByField, sortDirection, currencyType);
    } catch(HttpStatusIOException ex) {
      CmcErrorAdapter.adapt(ex);
    }
  ...
  public Map<String, CmcTicker> getCmcLatestQuote(CurrencyPair currencyPair)
          throws IOException {
  ...
  public Map<String, CmcTicker> getCmcLatestQuotes(Set<Currency> baseCurrencySet, Set<Currency> convertCurrencySet)
          throws IOException {
