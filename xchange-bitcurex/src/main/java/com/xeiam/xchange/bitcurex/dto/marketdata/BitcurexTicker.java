...
public BitcurexTicker(@JsonProperty("average_price") BigDecimal average_price, 
		@JsonProperty("total_spent") BigDecimal total_spent,
		@JsonProperty("best_bid") BigDecimal best_bid, 
		@JsonProperty("lowest_tx_price") BigDecimal lowest_tx_price,
		@JsonProperty("lowest_tx_spread") BigDecimal lowest_tx_spread, 
		@JsonProperty("best_ask") BigDecimal best_ask,
		@JsonProperty("price_change") BigDecimal price_change, 
		@JsonProperty("last_tx_price") BigDecimal last_tx_price, 
		@JsonProperty("currency") String currency,
		@JsonProperty("highest_tx_price") BigDecimal highest_tx_price, 
		@JsonProperty("highest_tx_spread") BigDecimal highest_tx_spread,
...
public String toString() {
	return "BitcurexTicker [average_price=" + average_price + ", total_spent="
			+ total_spent + ", best_bid=" + best_bid + ", lowest_tx_price="
			+ lowest_tx_price + ", lowest_tx_spread=" + lowest_tx_spread
			+ ", best_ask=" + best_ask + ", price_change=" + price_change
			+ ", last_tx_price=" + last_tx_price + ", currency=" + currency
			+ ", highest_tx_price=" + highest_tx_price + ", highest_tx_spread="
			+ highest_tx_spread + ", curr=" + curr + ", market=" + market
