...
public class UpbitTrade {
	 ...
	 * @param askBid
	 */
	public UpbitTrade(@JsonProperty("market") String market, @JsonProperty("trade_date_utc") String tradeDateUtc,
			@JsonProperty("trade_time_utc") String tradeTimeUtc, @JsonProperty("timestamp") BigDecimal timestamp,
			@JsonProperty("trade_price") BigDecimal tradePrice, @JsonProperty("trade_volume") BigDecimal tradeVolume,
			@JsonProperty("prev_closing_price") BigDecimal prevClosingPrice,
			@JsonProperty("change_price") BigDecimal changePrice, @JsonProperty("ask_bid") String askBid) {
		this.market = market;
