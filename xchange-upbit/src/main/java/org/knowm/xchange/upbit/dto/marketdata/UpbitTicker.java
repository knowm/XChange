...
public class UpbitTicker {
	 ...
	 * @param timestamp
	 */
	public UpbitTicker(@JsonProperty("market") String market, @JsonProperty("trade_date") String trade_date,
			@JsonProperty("trade_time") String trade_time, @JsonProperty("trade_date_kst") String trade_date_kst,
			@JsonProperty("trade_time_kst") String trade_time_kst,
			@JsonProperty("trade_timestamp") String trade_timestamp,
			@JsonProperty("opening_price") BigDecimal opening_price, @JsonProperty("high_price") BigDecimal high_price,
			@JsonProperty("low_price") BigDecimal low_price, @JsonProperty("trade_price") BigDecimal trade_price,
			@JsonProperty("prev_closing_price") BigDecimal prev_closing_price, @JsonProperty("change") String change,
			@JsonProperty("change_price") BigDecimal change_price, @JsonProperty("change_rate") BigDecimal change_rate,
