...
public class PusherStreamingServiceTest {
    ...
    public void testConnect() throws Exception {
        ...
        listener.getValue().onConnectionStateChange(new ConnectionStateChange(ConnectionState.CONNECTING, ConnectionState.CONNECTED));
    ...
    public void testSubscribeChannel() throws Exception {
        ...
        ArgumentCaptor<SubscriptionEventListener> subscription = ArgumentCaptor.forClass(SubscriptionEventListener.class);
