...
public class GeminiStreamingService extends JsonNettyStreamingService {
    ...
    public String getSubscribeMessage(String channelName, Object... args) throws IOException {
        return objectMapper.writeValueAsString(new GeminiWebSocketSubscriptionMessage(SUBSCRIBE, product));
    }

    @Override
    public String getUnsubscribeMessage(String channelName) throws IOException {
        return objectMapper.writeValueAsString(new GeminiWebSocketSubscriptionMessage(UNSUBSCRIBE, product));
    }
}
