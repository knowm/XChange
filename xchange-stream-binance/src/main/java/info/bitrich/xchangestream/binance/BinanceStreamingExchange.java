...
public class BinanceStreamingExchange extends BinanceExchange implements StreamingExchange {
    ...
    protected void initServices() {
        ...
        Boolean userHigherFrequency
                = MoreObjects.firstNonNull(
                        (Boolean) exchangeSpecification.getExchangeSpecificParametersItem(
    ...
    /**
     * Binance streaming API expects connections to multiple channels to be
     * defined at connection time. To define the channels for this connection
     * pass a `ProductSubscription` in at connection time.
     *
     * @param args A single `ProductSubscription` to define the subscriptions
     * required to be available during this connection.
