...
class BinanceFutureUserDataChannel implements AutoCloseable {
    ...
    BinanceFutureUserDataChannel(BinanceFutureAuthenticated binance, String apiKey, Runnable onApiCall) {
...
//            binance.keepAliveUserDataStream(apiKey, listenKey);
     ...
     * @throws BinanceFutureUserDataChannel.NoActiveChannelException If no listen key is currently available.
     */
    ...
    /**
     * Thrown on calls to {@link BinanceFutureUserDataChannel#getListenKey()} if no channel is currently
     * open.
     *
