...
public class BinanceLiveSubscriptionExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Note: See the doOnDispose below. It's here that we will send an unsubscribe request to Binance through the websocket instance.
        ...
        for (final CurrencyPair currencyPair : currencyPairs) {
            // Note: See the doOnDispose below. It's here that we will send an unsubscribe request to Binance through the websocket instance.
            Disposable tradeDisposable = exchange.getStreamingMarketDataService()
        ...
        Disposable xlmDisposable = exchange.getStreamingMarketDataService()
            ...
            .subscribe(
                trade -> {  });
        Disposable eosDisposable = exchange.getStreamingMarketDataService()
