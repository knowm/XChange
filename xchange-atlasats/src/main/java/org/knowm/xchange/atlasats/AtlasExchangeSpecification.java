...
public class AtlasExchangeSpecification extends ExchangeSpecification {
  ...
  public AtlasExchangeSpecification(Class<? extends Exchange> exchangeClass, String apiKey, ExchangeStreamingConfiguration streamingConfiguration) {
  ...
  protected void setStreamingConfiguration(ExchangeStreamingConfiguration streamingConfiguration) {
