...
public class PoloniexUserTradeTest {
  ...
  public void testTradeHistoryMultiPair() throws JsonParseException, JsonMappingException, IOException {
    ...
    final InputStream is = PoloniexUserTrade.class.getResourceAsStream("/org/knowm/xchange/poloniex/dto/trade/trade-history-multi-pair.json");
  ...
  public void testTradeHistorySinglePair() throws JsonParseException, JsonMappingException, IOException {
    ...
    final InputStream is = PoloniexUserTrade.class.getResourceAsStream("/org/knowm/xchange/poloniex/dto/trade/trade-history-single-pair.json");
