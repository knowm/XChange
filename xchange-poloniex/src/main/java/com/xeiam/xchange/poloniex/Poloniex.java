...
public interface Poloniex {
  ...
  @GET
  List<PoloniexCandlestick> getChartData(@QueryParam("command") String command, @QueryParam("currencyPair") String currencyPair, @QueryParam("start") long start, @QueryParam("end") long end,
      @QueryParam("period") int period) throws IOException;
}
