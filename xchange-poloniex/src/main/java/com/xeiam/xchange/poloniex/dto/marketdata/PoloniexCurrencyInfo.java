...
public class PoloniexCurrencyInfo {
  ...
  public PoloniexCurrencyInfo(@JsonProperty("maxDailyWithdrawal") BigDecimal maxDailyWithdrawal, @JsonProperty("txFee") BigDecimal txFee, @JsonProperty("minConf") int minConf, @JsonProperty("disabled") boolean disabled) {
