...
public class TradeServiceIntegration {
    ...
    private StopOrder sampleStopLimitOrder() throws IOException {
        ...
        return new StopOrder.Builder(BID, currencyPair).originalAmount(amount)
    ...
    public void testPlaceTestOrderTakeProfitLimitOrderShouldNotThrowAnyException() throws IOException {
        ...
        tradeService.placeTestOrder(TAKE_PROFIT_LIMIT, takeProfitLimitOrder, takeProfitLimitOrder.getLimitPrice(),
