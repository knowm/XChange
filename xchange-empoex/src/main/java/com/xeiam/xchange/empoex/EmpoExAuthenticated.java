...
public interface EmpoExAuthenticated extends EmpoEx {
  ...
  Map<String, Boolean> cancelEmpoExOrder(@PathParam("apiKey") String apiKey, @PathParam("orderId") String orderId) throws IOException, EmpoExException;

  @GET
  @Path("trade/buy/{apiKey}/{pairString}/{amount}/{price}/")
  EmpoExOrderResponse buy(@PathParam("apiKey") String apiKey, @PathParam("pairString") String pairString, @PathParam("amount") String amount, @PathParam("price") String price) throws IOException,
      EmpoExException;

  @GET
  @Path("trade/sell/{apiKey}/{pairString}/{amount}/{price}/")
  EmpoExOrderResponse sell(@PathParam("apiKey") String apiKey, @PathParam("pairString") String pairString, @PathParam("amount") String amount, @PathParam("price") String price) throws IOException,
      EmpoExException;
