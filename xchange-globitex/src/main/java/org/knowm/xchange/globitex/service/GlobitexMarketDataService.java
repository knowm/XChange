...
public class GlobitexMarketDataService extends GlobitexMarketDataServiceRaw implements MarketDataService {
    ...
    public Ticker getTicker(CurrencyPair currencyPair, Object... args) throws IOException {
        ...
        return GlobitexAdapters.adaptToTicker(getGlobitexTickerBySymbol(currencyPair),exchange.getExchangeMetaData().getCurrencies());
    }

    @Override
    public List<Ticker> getTickers(Params params) throws IOException {
        return GlobitexAdapters.adaptToListTicker(getGlobitexTickers(),exchange.getExchangeMetaData().getCurrencies());
    }
