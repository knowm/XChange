...
public class OkxStreamingAuthenticator {
    public static String getSHA256String(String str, String key) {
        ...
        SecretKeySpec signingKey = new SecretKeySpec(key.getBytes(StandardCharsets.US_ASCII), "HmacSHA256");
        try {
    ...
    public static String generateSignature(
            String secret, Object... args) {
        return getSHA256String(Arrays.stream(args).map(Object::toString).collect(Collectors.joining()), secret);
    }
}
