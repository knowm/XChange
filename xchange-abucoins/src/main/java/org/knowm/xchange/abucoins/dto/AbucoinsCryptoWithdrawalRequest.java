...
public class AbucoinsCryptoWithdrawalRequest {
   ...
   */
  public AbucoinsCryptoWithdrawalRequest(BigDecimal amount, String currency, String method, String address, String tag) {
    this.amount = amount;
  ...
  public String toString() {
    return "AbucoinsCryptoWithDrawalRequest [amount=" + amount + ", currency=" + currency + ", method=" + method + ", address=" + address + ", tag="
        + tag + "]";
  }
}
