...
public class AbucoinsFullTicker extends AbucoinsTicker {
   ...
   */
  public AbucoinsFullTicker(@JsonProperty("product_id") String productID, @JsonProperty("trade_id") String tradeID,
      @JsonProperty("price") BigDecimal price, @JsonProperty("size") BigDecimal size, @JsonProperty("bid") BigDecimal bid,
      @JsonProperty("ask") BigDecimal ask, @JsonProperty("volume") BigDecimal volume, @JsonProperty("time") String time) {
  ...
  public String toString() {
    return "AbucoinsFullTicker [productID=" + productID + ", tradeID=" + tradeID + ", price=" + price + ", size=" + size + ", bid=" + bid + ", ask="
