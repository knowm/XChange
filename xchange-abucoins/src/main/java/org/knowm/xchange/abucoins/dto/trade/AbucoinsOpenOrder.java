...
public class AbucoinsOpenOrder {
  ...
  public AbucoinsOpenOrder(@JsonProperty("user") String user, @JsonProperty("type") String type, @JsonProperty("symbol1") String symbol1, @JsonProperty("symbol2") String symbol2,
