...
public class AbucoinsWithdrawalHistory extends AbucoinsHistory {
  ...
  public AbucoinsWithdrawalHistory(@JsonProperty("withdraw_id") String withdrawID, @JsonProperty("currency") String currency,
  ...
  public String toString() {
    return "AbucoinsDepositHistory [withdrawID=" + withdrawID + ", currency=" + currency + ", date=" + date + ", amount=" + amount + ", fee=" + fee
