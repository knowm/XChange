...
import com.xeiam.xchange.bittrex.v1.service.BittrexHmacPostBodyDigest;
import com.xeiam.xchange.bittrex.v1.service.BittrexPayloadDigest;
...
public class BittrexBasePollingService<T extends Bittrex> extends BittrexBaseService implements BasePollingService {
  ...
  public BittrexBasePollingService(Class<T> type, ExchangeSpecification exchangeSpecification) {
    ...
    this.signatureCreator = BittrexHmacPostBodyDigest.createInstance(exchangeSpecification.getSecretKey());
    this.payloadCreator = new BittrexPayloadDigest();
