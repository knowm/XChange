...
public class BittrexTickersResponse {
  ...
  public BittrexTickersResponse(@JsonProperty("success") boolean success, @JsonProperty("message") String message, @JsonProperty("result") ArrayList<BittrexTicker> result) {
