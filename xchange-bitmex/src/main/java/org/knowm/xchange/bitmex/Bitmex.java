...
public interface Bitmex {
    ...
    class PlaceOrderCommand {
        ...
        public PlaceOrderCommand(final BitmexPlaceOrderParameters parameters) {
            ...
            this.orderType = parameters.getOrderType() != null ? parameters.getOrderType().toApiParameter() : null;
            this.clOrdID = parameters.getClOrdId();
            this.executionInstructions = parameters.getExecutionInstructions() != null ?
                    StringUtils.join(parameters.getExecutionInstructions(), ",  ") : null;
            this.clOrdLinkID = parameters.getClOrdLinkId();
            this.contingencyType = parameters.getContingencyType() != null ? parameters.getContingencyType().toApiParameter() : null;
            this.pegOffsetValue = parameters.getPegOffsetValue();
            this.pegPriceType = parameters.getPegPriceType() != null ? parameters.getPegPriceType().toApiParameter() : null;
            this.timeInForce = parameters.getTimeInForce() != null ? parameters.getTimeInForce().toApiParameter() : null;
