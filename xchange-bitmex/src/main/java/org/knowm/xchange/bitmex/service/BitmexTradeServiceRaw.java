...
public class BitmexTradeServiceRaw extends BitmexBaseService {
        ...
        try {
            return updateRateLimit(
                    bitmex.placeOrder(
                            ...
                            parameters.getContingencyType() != null ? parameters.getContingencyType().toApiParameter() : null,
    ...
    @Nonnull
    public List<BitmexPrivateOrder> placeOrderBulk(@Nonnull Collection<Bitmex.PlaceOrderCommand> commands)
            throws IOException, ExchangeException {
        try {
    ...
    @Nonnull
    public List<BitmexPrivateOrder> replaceOrderBulk(@Nonnull Collection<Bitmex.ReplaceOrderCommand> commands)
            throws IOException, ExchangeException {
        try {
            String s = ObjectMapperHelper.toCompactJSON(commands);
