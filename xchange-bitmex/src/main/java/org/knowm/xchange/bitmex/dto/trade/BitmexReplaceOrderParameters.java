...
public class BitmexReplaceOrderParameters {
    ...
    public static class Builder {
        ...
        public BitmexReplaceOrderParameters build() {
            return new BitmexReplaceOrderParameters(orderId, origClOrdId, clOrdId, simpleOrderQuantity, orderQuantity,
                    simpleLeavesQuantity, leavesQuantity, price, stopPrice, pegOffsetValue, text);
        }
