...
public class TradeApiTest {
    ...
    public void tradeGetTest() throws ApiException {
        ...
        List<BitmexTrade> response = api.tradeGet(symbol, filter, columns, count, start, reverse, startTime, endTime);
    ...
    public void tradeGetBucketedTest() throws ApiException {
        ...
        OffsetDateTime startTime = null;
        OffsetDateTime endTime = null;
        List<BitmexTradeBin> response = api.tradeGetBucketed(binSize, partial, symbol, filter, columns, count, start, reverse, startTime, endTime);
