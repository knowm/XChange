...
public class BitmexExecutionTest {
    ...
    public void testDesialization() throws IOException {
        ...
        InputStream resourceAsStream = getClass().getClassLoader().getResourceAsStream("info/bitrich/xchangestream/bitmex/dto/execution.json");
        BitmexExecution bitmexExecution = objectMapper.readValue(resourceAsStream, BitmexExecution.class);
