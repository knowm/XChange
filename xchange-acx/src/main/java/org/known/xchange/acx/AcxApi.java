...
public interface AcxApi {
  ...
  AcxOrderBook getOrderBook(@PathParam("market") String market, @PathParam("bids_limit") long bidsLimit, @PathParam("asks_limit") long asksLimit)
      throws IOException;
  ...
  AcxAccountInfo getAccountInfo(@PathParam("access_key") String accessKey, @PathParam("tonce") long tonce,
  ...
  List<AcxOrder> getOrders(@PathParam("access_key") String accessKey, @PathParam("tonce") long tonce, @PathParam("market") String market,
      @PathParam("signature") ParamsDigest signature) throws IOException;
  ...
  @POST
  @Path("/orders.json")
  AcxOrder createOrder(@FormParam("access_key") String accessKey, @FormParam("tonce") long tonce, @FormParam("market") String market,
      @FormParam("side") String side, @FormParam("volume") String volume, @FormParam("price") String price, @FormParam("ord_type") String ordType,
  ...
  AcxOrder cancelOrder(@FormParam("access_key") String accessKey, @FormParam("tonce") long tonce, @FormParam("id") String id,
      @FormParam("signature") ParamsDigest signature) throws IOException;
