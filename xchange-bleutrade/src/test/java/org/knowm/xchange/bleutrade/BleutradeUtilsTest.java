...
public class BleutradeUtilsTest {
  ...
  public void shouldConvertCurrencyPairToString() {
    assertThat(BleutradeUtils.toPairString(org.knowm.xchange.currency.CurrencyPair.BTC_AUD))
        .isEqualTo("BTC_AUD");
    assertThat(
            BleutradeUtils.toPairString(
                org.knowm.xchange.currency.CurrencyPair.build("BLEU", "AUD")))
        .isEqualTo("BLEU_AUD");
  }

  @Test
  public void shouldConvertStringToCurrencyPair() {
    assertThat(BleutradeUtils.toCurrencyPair("BTC_AUD"))
        .isEqualTo(org.knowm.xchange.currency.CurrencyPair.BTC_AUD);
    assertThat(BleutradeUtils.toCurrencyPair("BLEU_AUD"))
        .isEqualTo(org.knowm.xchange.currency.CurrencyPair.build("BLEU", "AUD"));
  }
