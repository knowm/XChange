...
public class TickerFetchIntegration {
  ...
  public void tickerFetchTest() throws Exception {
    ...
    //TODO: getTicker() call with a single currency pair returns a result json object, not a result json array
    ...
    List<BleutradeTicker> tickers = ((BleutradeMarketDataService) marketDataService).getBleutradeTickers();
