...
public class BleutradeDtoTest extends BleutradeDtoTestSupport {
  ...
  protected static final String CURRENCIES_RETURN_STR = "BleutradeCurrenciesReturn [success=true, message=, result=["
      ...
      + "IsActive=true, CoinType=BITCOIN, additionalProperties={MaintenanceMode=false}]" + "], additionalProperties={}]";
  ...
  protected static final String MARKET_HISTORY_RETURN_STR = "BleutradeMarketHistoryReturn [success=true, message=, result=["
      ...
      + "OrderType=SELL, additionalProperties={}]], " + "additionalProperties={}]";
  ...
  protected static final String MARKETS_RETURN_STR = "BleutradeMarketsReturn [success=true, message=, result=["
      ...
      + "BaseCurrencyLong=Bitcoin, MinTradeSize=0.10000000, " + "MarketName=DOGE_BTC, IsActive=true, additionalProperties={}], "
  ...
  protected static final String OPEN_ORDERS_RETURN_STR = "BleutradeOpenOrdersReturn [success=true, message=, result=["
      ...
      + "additionalProperties={}], " + "BleutradeOpenOrder [OrderId=65724, Exchange=DOGE_BTC, Type=SELL, Quantity=150491.98700000, "
  ...
  protected static final String ORDER_BOOK_RETURN_STR = "BleutradeOrderBookReturn [success=true, message=, result=BleutradeOrderBookResult "
      ...
      + "BleutradeLevel [Quantity=13.49989999, Rate=6.76260099, additionalProperties={}]], " + "additionalProperties={}], additionalProperties={}]";
  ...
  protected static final String TICKER_RETURN_STR = "BleutradeTickerReturn [success=true, message=, result=["
      ...
      + "TimeStamp=2014-07-29 11:48:02, Bid=0.01268311, Ask=0.01333000, IsActive=true, additionalProperties={}]], " + "additionalProperties={}]";
