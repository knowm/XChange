...
public interface BleutradeTestData {

  CurrencyPair BLEU_BTC_CP = new CurrencyPair("BLEU", "BTC");

  Balance[] ACCOUNT_BALANCES = new Balance[] {
  ...
  LimitOrder[] PLACED_ORDERS = new LimitOrder[] {
  ...
  LimitOrder[] ORDERS = new LimitOrder[] {   // timestampas are always null: 'created' to 'timestamp' convertation is probably missed
  ...
  LimitOrder[] BIDS = new LimitOrder[] {
  ...
  LimitOrder[] ASKS = new LimitOrder[] {
  ...
  MarketMetaData[] META_DATA_LIST = new MarketMetaData[] {
  ...
  String[] META_DATA_STR = new String[] {
