...
public class BleutradeServiceTestSupport implements BleutradeTestData {
  ...
  protected static final String[] BLEUTRADE_TICKERS_STR = new String[] {
      "BleutradeTicker [MarketName=BLEU_BTC, PrevDay=0.00095000, High=0.00105000, Low=0.00086000, Last=0.00101977, Average=0.00103455, "
          + "Volume=2450.97496015, BaseVolume=2.40781647, TimeStamp=2014-07-29 11:19:30, Bid=0.00100000, Ask=0.00101977, IsActive=true, " +
      ...
      "BleutradeTicker [MarketName=LTC_BTC, PrevDay=0.00095000, High=0.01333000, Low=0.01167001, Last=0.01333000, Average=0.01235000, "
          + "Volume=14.46077245, BaseVolume=0.18765956, TimeStamp=2014-07-29 11:48:02, Bid=0.01268311, Ask=0.01333000, IsActive=true, " +
        "additionalProperties={}]"
  };
  ...
  protected static final String[] BLEUTRADE_CURRENCIES_STR = new String[] {
  ...
  protected static final String[] BLEUTRADE_MARKETS_STR = new String[] {
  ...
  protected static final List<BleutradeBalance> BLEUTRADE_ACCOUNT_INFO = Collections.unmodifiableList(Arrays.asList(
