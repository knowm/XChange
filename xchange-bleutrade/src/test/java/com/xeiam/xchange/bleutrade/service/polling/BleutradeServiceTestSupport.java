...
public class BleutradeServiceTestSupport extends BleutradeTestData {
  ...
  protected static List<BleutradeOpenOrder> expectedBleutradeOpenOrdersList() {
    return Arrays.asList(
      createBleutradeOpenOrder("65489", "LTC_BTC", "BUY",
        new BigDecimal("20.00000000"), new BigDecimal("5.00000000"), "0.16549400",
        new BigDecimal("0.01268311"), "OPEN", "2014-08-03 13:55:20", "My optional comment, eg function id #123"),
      createBleutradeOpenOrder("65724", "DOGE_BTC", "SELL", new BigDecimal("150491.98700000"),
        new BigDecimal("795.00000000"), "0.04349400",
  ...
  protected static final String EXPECTED_BLEUTRADE_TICKER_STR =
    "Ticker [currencyPair=BLEU/BTC, last=0.00101977, bid=0.00100000, ask=0.00101977, "
  ...
  protected static List<BleutradeTrade> expectedBleutradeTrades() {
    return Collections.unmodifiableList(Arrays.asList(
      createBleutradeTrade("2014-07-29 18:08:00", new BigDecimal("654971.69417461"), new BigDecimal("0.00000055"),
        new BigDecimal("0.360234432"), "BUY"),
      createBleutradeTrade("2014-07-29 18:12:35", new BigDecimal("120.00000000"), new BigDecimal("0.00006600"),
        new BigDecimal("0.360234432"), "SELL")
    ));
  }
  ...
  protected static List<BleutradeMarket> expectedBleutradeMarkets() {
    return Collections.unmodifiableList(Arrays
      .asList(
        ...
        createBleutradeMarket("BLEU", "BTC", "Bleutrade Share", "Bitcoin", new BigDecimal("0.00000001"), "BLEU_BTC",
          true)
      ));
  }
  ...
  protected static List<BleutradeBalance> expectedBleutradeAccountInfo() {
    return Collections.unmodifiableList(Arrays.asList(
      createBalance(new BigDecimal("10.00000000"), "AUD", new BigDecimal("40.00000000"),
        new BigDecimal("30.00000000"), true),
      createBalance(new BigDecimal("40.00000000"), "BTC", new BigDecimal("100.00000000"),
        new BigDecimal("60.00000000"), false),
      createBalance(new BigDecimal("70.00000000"), "BLEU", new BigDecimal("160.00000000"),
        new BigDecimal("90.00000000"), true)
    ));
  }
  ...
  protected static BleutradeBalance createBalance(BigDecimal available, String currency, BigDecimal balance,
                                                  BigDecimal pending, Boolean isActive) {
  ...
  protected static BleutradeTicker createBleutradeTicker(String marketName, BigDecimal prevDay, BigDecimal high,
                                                         BigDecimal low, BigDecimal last,
      BigDecimal average, BigDecimal volume, BigDecimal baseVolume, String timestamp, BigDecimal bid,
