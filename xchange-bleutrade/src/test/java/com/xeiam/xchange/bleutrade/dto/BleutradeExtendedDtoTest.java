...
public class BleutradeExtendedDtoTest extends BleutradeDtoTestSupport {
  ...
  public void shouldParseBalanceReturn() throws Exception {
    ...
    assertThat(response.toString()).isEqualTo("BleutradeBalanceReturn [success=true, message=, "
        + "result=BleutradeBalance [Currency=BTC, Balance=15.49843675, Available=13.98901996, Pending=0E-8, CryptoAddress=1NKh9X1z4Q4AbBnEgNiKU177GMyeQUexC9, IsActive=true, "
        + "additionalProperties={bar=true, foo=1}], "
        + "additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedBalancesReturn() throws Exception {
    // when
    ...
    assertThat(response.toString()).isEqualTo(
        "BleutradeBalancesReturn [success=true, message=, result=["
            + "BleutradeBalance [Currency=DOGE, Balance=0E-8, Available=0E-8, Pending=0E-8, CryptoAddress=DBSwFELQiVrwxFtyHpVHbgVrNJXwb3hoXL, IsActive=true, additionalProperties={foo=1}], "
            + "BleutradeBalance [Currency=BTC, Balance=15.49843675, Available=13.98901996, Pending=0E-8, CryptoAddress=1NKh9X1z4Q4AbBnEgNiKU177GMyeQUexC9, IsActive=true, additionalProperties={bar=true}]], "
            + "additionalProperties={ext=extended value}]");
  }

  // current response format is differs from /market/cancel output (see https://bleutrade.com/help/API)
  @Test
  public void shouldParseExtendedCancelOrderReturn() throws Exception {
    // when
  ...
  @Test
  public void shouldParseExtendedCurrenciesReturn() throws Exception {
    // when
  ...
  @Test
  public void shouldParseExtendedDepositAddressReturn() throws Exception {
    // when
    ...
    assertThat(response.toString()).isEqualTo(
        "BleutradeDepositAddressReturn [success=true, message=, result="
            + "BleutradeDepositAddress [Currency=BTC, Address=1NKh9X1z4Q4AbBnEgNiKU177GMyeQUexC9, additionalProperties={foo=1}], additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedMarketHistoryReturn() throws Exception {
    // when
    ...
    assertThat(response.toString()).isEqualTo(
        "BleutradeMarketHistoryReturn [success=true, message=, result=["
            + "BleutradeTrade [TimeStamp=2014-07-29 18:08:00, Quantity=654971.69417461, Price=5.5E-7, Total=0.360234432, OrderType=BUY, additionalProperties={foo=1}], "
            + "BleutradeTrade [TimeStamp=2014-07-29 18:12:35, Quantity=120.00000000, Price=0.00006600, Total=0.360234432, OrderType=SELL, additionalProperties={bar=true}]], "
            + "additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedMarketsReturn() throws Exception {
    // when
    ...
    assertThat(response.toString()).isEqualTo(
        "BleutradeMarketsReturn [success=true, message=, result=["
            + "BleutradeMarket [MarketCurrency=DOGE, BaseCurrency=BTC, MarketCurrencyLong=Dogecoin, BaseCurrencyLong=Bitcoin, MinTradeSize=0.10000000, MarketName=DOGE_BTC, IsActive=true, additionalProperties={foo=1}], "
            + "BleutradeMarket [MarketCurrency=BLEU, BaseCurrency=BTC, MarketCurrencyLong=Bleutrade Share, BaseCurrencyLong=Bitcoin, MinTradeSize=1E-8, MarketName=BLEU_BTC, IsActive=true, additionalProperties={bar=true}]], "
            + "additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedOpenOrdersReturn() throws Exception {
    // when
    ...
    assertThat(response.toString()).isEqualTo(
        "BleutradeOpenOrdersReturn [success=true, message=, result=["
            + "BleutradeOpenOrder [OrderId=65489, Exchange=LTC_BTC, Type=BUY, Quantity=20.00000000, QuantityRemaining=5.00000000, QuantityBaseTraded=0.16549400, Price=0.01268311, Status=OPEN, Created=2014-08-03 13:55:20, Comments=My optional comment, eg function id #123, additionalProperties={foo=1}], "
            + "BleutradeOpenOrder [OrderId=65724, Exchange=DOGE_BTC, Type=SELL, Quantity=150491.98700000, QuantityRemaining=795.00000000, QuantityBaseTraded=0.04349400, Price=5.5E-7, Status=OPEN, Created=2014-07-29 18:45:17, Comments=Function #123 Connect #456, additionalProperties={bar=true}]], "
            + "additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedOrderBookReturn() throws Exception {
    // when
    ...
    assertThat(response.toString()).isEqualTo(
        "BleutradeOrderBookReturn [success=true, message=, result=BleutradeOrderBookResult "
            + "[buy=[BleutradeLevel [Quantity=4.99400000, Rate=3.00650900, additionalProperties={ext=1}], BleutradeLevel [Quantity=50.00000000, Rate=3.50000000, additionalProperties={ext=2}]], "
            + "sell=[BleutradeLevel [Quantity=12.44147454, Rate=5.13540000, additionalProperties={ext=3}], BleutradeLevel [Quantity=100.00000000, Rate=6.25500000, additionalProperties={ext=4}], "
            + "BleutradeLevel [Quantity=30.00000000, Rate=6.75500001, additionalProperties={ext=5}], BleutradeLevel [Quantity=13.49989999, Rate=6.76260099, additionalProperties={ext=6}]], "
            + "additionalProperties={foo=1}], additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedPlaceOrderReturn() throws Exception {
    // when
    final BleutradePlaceOrderReturn response = parse("ExtendedPlaceOrderReturn", BleutradePlaceOrderReturn.class);

    // then
    assertThat(response.toString()).isEqualTo("BleutradePlaceOrderReturn [success=true, message=, result=BleutradeOrderId [orderid=65498, additionalProperties={foo=1}], "
        + "additionalProperties={ext=extended value}]");
  }

  @Test
  public void shouldParseExtendedTickerReturn() throws Exception {
    // when
  ...
  public void shouldParseExtendedCancelOrderReturnAsException() throws Exception {
    // when
