...
public class BitbnsMarketDataServiceRaw extends BitbnsBaseService {
  ...
  public BItbnsOrderBooks getBitbnsOrderBookBuy(CurrencyPair currencyPair, Object... args)
      throws IOException {

    return bitBns.getOrderBookBuy(getSymbol(currencyPair, args), args[0].toString());
  }

  public BItbnsOrderBooks getBitbnsOrderBookSell(CurrencyPair currencyPair, Object... args)
      throws IOException {
