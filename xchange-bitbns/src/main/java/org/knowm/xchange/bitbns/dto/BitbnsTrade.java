...
public class BitbnsTrade {
	...
	public BitbnsTrade(@JsonProperty("p") BigDecimal price, @JsonProperty("q") BigDecimal quantity,
	...
	public String toString() {
		return "BitbnsTrade [price=" + price + ", quantity=" + quantity + ", symbol=" + symbol + ", timestamp="
