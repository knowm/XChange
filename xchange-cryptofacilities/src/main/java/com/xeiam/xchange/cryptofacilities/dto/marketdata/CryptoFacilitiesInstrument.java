...
public class CryptoFacilitiesInstrument extends CryptoFacilitiesResult {
    ...
    public CryptoFacilitiesInstrument(@JsonProperty("result") String result
    ...
    public String toString() {	
        return "CryptoFacilitiesInstrument [tradeable=" + tradeable 
                + ", lastTradingTime=" + (lastTradingTime == null ? "null" : DATE_FORMAT.format(lastTradingTime))
                + ", symbol=" + symbol
