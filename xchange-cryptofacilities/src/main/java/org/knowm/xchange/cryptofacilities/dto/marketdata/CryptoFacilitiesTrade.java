...
public class CryptoFacilitiesTrade extends CryptoFacilitiesResult {
  ...
  public CryptoFacilitiesTrade(@JsonProperty("result") String result, @JsonProperty("error") String error,
  ...
  public String toString() {
    return "CryptoFacilitiesTrade [uid=" + uid + ", timestamp=" + DATE_FORMAT.format(timestamp) + ", tradeable=" + tradeable + ", unit=" + unit
