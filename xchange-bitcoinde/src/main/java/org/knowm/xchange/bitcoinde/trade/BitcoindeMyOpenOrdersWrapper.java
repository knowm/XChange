...
public class BitcoindeMyOpenOrdersWrapper {
     ...
     * @param orders
     */
    public BitcoindeMyOpenOrdersWrapper(List<BitcoindeMyOrder> orders, BitcoindePage page, List<Object> errors, Integer credits, BitcoindeMaintenance maintenance) {
        super();
        this.orders = orders;
        this.page = page;
        this.errors = errors;
