...
public class BitcoindeRate {
   ...
   * 
   * @param rate_weighted
   *          Usually, the value “rate_weighted” shows the weighted average
   *          price of the last 3 hours. If the amount of trades falls below
   *          a critical amount in the last 3 hours, the 12 hour average is
   *          returned here.
   * @param rate_weighted_12h
   *          Weighted average price of the last 3 hours.
   * @param rate_weighted_3h
   *          Weighted average price of the last 12 hours.
   */
  public BitcoindeRate(@JsonProperty("rate_weighted") String rate_weighted, @JsonProperty("rate_weighted_12h") String rate_weighted_12h, @JsonProperty("rate_weighted_3h") String rate_weighted_3h) {
