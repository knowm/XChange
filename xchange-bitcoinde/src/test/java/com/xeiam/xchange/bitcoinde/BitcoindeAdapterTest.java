...
public class BitcoindeAdapterTest {
	...
	public void testTradesAdapter() throws IOException {
		...
		// Use our adapter to get a generic Trades object from a BitcoindeTrade[] object
		...
		Date date = new Date(); 
		date.setTime(1428255708L * 1000); // Create the expected date for trade 0
		assertThat(trades.getTrades().get(0).getTimestamp()).isEqualTo(date); // Make sure the dates match
	}
