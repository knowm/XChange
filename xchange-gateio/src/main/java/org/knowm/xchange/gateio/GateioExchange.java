...
public class GateioExchange extends BaseExchange implements Exchange {
  ...
  public void remoteInit() throws IOException {
    ...
    Map<CurrencyPair, GateioMarketInfo> currencyPair2GateioMarketInfoMap = ((GateioMarketDataServiceRaw) marketDataService).getGateioMarketInfo();
    exchangeMetaData = GateioAdapters.adaptToExchangeMetaData(currencyPair2GateioMarketInfoMap);
  }
}
