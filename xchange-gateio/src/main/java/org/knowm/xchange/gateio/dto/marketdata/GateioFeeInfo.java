...
public class GateioFeeInfo {
    ...
    public String toString() {
        return "GateioFeeInfo{" +
                ...
                ", withdrawFix='" + withdrawFix + '\'' +
                ", withdrawDayLimit='" + withdrawDayLimit + '\'' +
                ", withdrawAmountMini=" + withdrawAmountMini +
                ", withdrawDayLimitRemain=" + withdrawDayLimitRemain +
                ", withdrawEachTimeLimit=" + withdrawEachTimeLimit +
                ", withdrawFixOnChainEth=" + withdrawFixOnChainEth +
                ", withdrawFixOnChainBtc=" + withdrawFixOnChainBtc +
                ", withdrawFixOnChainTrx=" + withdrawFixOnChainTrx +
                ", withdrawFixOnChainEos=" + withdrawFixOnChainEos +
                '}';
    }
