...
public class CoinsuperTradeServiceRaw extends CoinsuperBaseService {
	   ...
	   * @throws IOException
	   */
	  public CoinsuperResponse<CoinsuperOrder> createOrder(Map<String, String> order) throws IOException {
		  RestRequestParam parameters = parameters = RestApiRequestHandler.generateRequestParam(order, this.apiKey, this.secretKey);
	  ...
	  public boolean cancelCoinsuperOrder(Map<String,String> data) throws IOException {
        ...
        CoinsuperResponse<CoinsuperCancelOrder> coinsuperCancelOrder = coinsuper.cancelOrder(parameters);
	   ...
	   * @throws IOException
	   */
	  public CoinsuperResponse<List<OrderDetail>> orderDetails(Map<String,String> parameters) throws IOException {
