...
public static class Asset {	    
    ...
    public Asset(CoinsuperBalance aAB, CoinsuperBalance aMR, CoinsuperBalance bCH, CoinsuperBalance bTC, CoinsuperBalance bUC, CoinsuperBalance cCCX, CoinsuperBalance cEEK, CoinsuperBalance cEN, CoinsuperBalance dASH, CoinsuperBalance dX, CoinsuperBalance eOS, CoinsuperBalance eTC, CoinsuperBalance eTH, CoinsuperBalance eTK, CoinsuperBalance hOLD, CoinsuperBalance iOVC, CoinsuperBalance lTC, CoinsuperBalance mEDX, CoinsuperBalance nEO, CoinsuperBalance nEWOS, CoinsuperBalance oMG, CoinsuperBalance pRL, CoinsuperBalance qTUM, CoinsuperBalance rLM, CoinsuperBalance tEST, CoinsuperBalance tHRT, CoinsuperBalance uSD, CoinsuperBalance uST, CoinsuperBalance xCCC, CoinsuperBalance xEM, CoinsuperBalance xRP) {
        super();
        this.aAB = aAB;
        this.aMR = aMR;
        this.bCH = bCH;
