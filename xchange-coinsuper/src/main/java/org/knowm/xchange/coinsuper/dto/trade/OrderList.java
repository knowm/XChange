...
public class OrderList {
     ...
     * @param quantity
     */
    public OrderList(long orderNo, String action, String orderType, String priceLimit, String symbol, String quantity, String quantityRemaining, String amount, String amountRemaining, String fee, long utcUpdate, long utcCreate, String state) {
        super();
    ...
    public String toString() {
        return new ToStringBuilder(this).append("orderNo", orderNo).append("action", action).append("orderType", orderType).append("priceLimit", priceLimit).append("symbol", symbol).append("quantity", quantity).append("quantityRemaining", quantityRemaining).append("amount", amount).append("amountRemaining", amountRemaining).append("fee", fee).append("utcUpdate", utcUpdate).append("utcCreate", utcCreate).append("state", state).toString();
    }
