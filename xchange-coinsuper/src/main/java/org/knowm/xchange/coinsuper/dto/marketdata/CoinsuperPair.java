...
public class CoinsuperPair {
     ...
     * @param quantityMax
     */
    public CoinsuperPair(String symbol, String quantityMin, String quantityMax, String priceMin, String priceMax, String deviationRatio) {
        super();
        this.symbol = symbol;
    ...
    public String toString() {
        return new ToStringBuilder(this).append("symbol", symbol).append("quantityMin", quantityMin).append("quantityMax", quantityMax).append("priceMin", priceMin).append("priceMax", priceMax).append("deviationRatio", deviationRatio).toString();
    }
