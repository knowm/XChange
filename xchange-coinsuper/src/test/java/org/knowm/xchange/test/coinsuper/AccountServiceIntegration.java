...
public class AccountServiceIntegration {
	...
	private static void raw(CoinsuperAccountServiceRaw accountService) throws IOException {
	    ...
	    System.out.println("BTC:"+coinsuperResponse.getData().getResult().getAsset().getBTC().getTotal());
	    System.out.println("BTC:"+coinsuperResponse.getData().getResult().getAsset().getBTC().getAvailable());
	    System.out.println("ETH:"+coinsuperResponse.getData().getResult().getAsset().getETH().getAvailable());
	}	
